...
parameter 
          ...
          W_SOP            = 6'd28,
          W_Eop            = 6'd29,
          ST_end_write_en1 = 6'd30,
          store_SPI0       = 6'd31,
          store_SPI1       = 6'd32,
          ST_wait_eop2     = 6'd33,
          store_SPI2       = 6'd34,
          store_SPI3       = 6'd35,
          st_write_data1   = 6'd36,
          store_SOP1       = 6'd37,
          store_Eop1       = 6'd38,
          ST_wait_buffer2  = 6'd39,
          SPI0             = 6'd40,
          SPI1             = 6'd41,
          SPI2             = 6'd42,
          SPI3             = 6'd43,
...
begin : next_state_block_proc
   ...
   case (current_state) 
      ...
      ST_wait_eop2: begin
         next_state = ST_wait_buffer2;
         csm_to_ST_wait_buffer2 = 1'b1;
      end
      store_SPI2: begin
         next_state = SPI3;
      end
...
begin : csm_wait_block_proc
   ...
   else if (csm_to_ST_wait_buffer2 == 1'b1) begin
      csm_next_timer = 3'd3;  //no cycles(4)-1=3
   end
   else begin
