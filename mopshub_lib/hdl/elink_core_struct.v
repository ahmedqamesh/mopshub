...
wire  [31:0] time_limit_trim;          //corresponds to 25 msec if the FPGA freq is 40Mhz
...
assign time_limit_trim         = 32'd1000000;   //corresponds to 25 msec if the FPGA freq is 40Mhz
...
assign Kchar_comma = 8'b10111100;//K28.5  BC
assign Kchar_eop = 8'b11011100;// K28.6 DC
assign Kchar_sop = 8'b00111100;// K28.1 3C
assign COMMAn = 10'b1100000101;
assign COMMAp = 10'b0011111010;
