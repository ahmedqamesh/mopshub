...
buffer_tra_elink_spi buffer_tra_elink_spi_mon0( 
   .addr            (addr_read), 
          ...
          case(data_tra_10bitin[7:0])
            ...
            begin
              ...
              if (dbg_spi) // Measurement Board 
                ...
                begin 
                  spi_mon_reg   = 1'b1; // I switched them here for debuging
                  spi_can_reg   = 1'b0; 
                end
            end
