...
elink_core elink_core0( 
   ...
   .irq_spi_power_on      (start_power_on)
); 
...
initial 
  begin
  start_read_mon         = 1'b0;
  fifo_flush             = 1'b0;    // Upon receiving a reset message on the CANbus. FSM goes into a known state
  end_cnt                = 1'b0;
  cnt_done               = 1'b0;
  abort                  = 1'b0;
  time_limit             = 32'd50000000;   //corresponds to 5 sec if the FPGA freq is 40Mhz
  end
