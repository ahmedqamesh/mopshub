...
begin
   case(addr)
       5'b01111 : data_init_reg = 16'h00FF;//33;//         //  prescalar register value 5'h0F
       5'b01110 : data_init_reg = 16'h00A3;//E3;//         // general register.first 7bits=0 then sjw,tseg1,tseg2 each 3bits [0000000 010 100 011]5'h0E
