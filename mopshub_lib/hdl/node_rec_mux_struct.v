...
// HDL Embedded Text Block 1 reset_2
// reset_ 1   
assign reset = !rst;
//assign can_rec_updated = can_rec_reg;
assign new_loop_trig = (end_choose_bus == 1'b1) ? 1:0;                                   
