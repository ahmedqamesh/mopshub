...
wire  [31:0] can_rec;
wire  [4:0]  can_rec_cnt;
wire         init_bus_select;   // to initialize the node
wire         ireqsucrec;


// Instances 
bit_counter #(5) bit_counter_canakari( 
   .ext_rst    (), 
   .rst        (rst), 
   .data_out   (can_rec_cnt), 
   .clk        (clk), 
   .cnt_enable (init_bus_select)
); 
