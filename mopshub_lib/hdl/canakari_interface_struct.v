...
canakari_rec_buffer bus_select_buffer( 
   .clk          (clk), 
   .data_tra_in  (data_tra_select), 
   .buffer_en    (set_bus_id), 
   .rst          (rst), 
...
assign data_tra_select_sig =(initi ==1) ? can_tra_select_cnt  : data_tra_out;
