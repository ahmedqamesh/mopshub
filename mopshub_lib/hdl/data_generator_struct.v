...
begin
  ...
  begin
    ch_id   <= 5'h0;
    bus_id  <= 8'h20;
    payload <= {sdoid,16'h0, 16'h0, 16'h0, 8'h0, bus_id};
  end
  else
  case (bus_cnt)
    5'h0 : begin 
      bus_id  <= 8'h0; 
      payload  <= {sdoid,16'h4010, 16'h2301, 16'h0,8'h0, bus_id};// ch0
      
    end
    5'h1 : begin
      bus_id  <= 8'h1; 
      payload  <= {sdoid,16'h4010, 16'h2302, 16'h0,8'h0, bus_id};//ch1
      
    end
    5'h2 : begin 
      bus_id  <= 8'h2; 
      payload  <= {sdoid,16'h4010, 16'h2303, 16'h0,8'h0, bus_id};//ch2
      
    end
    5'h3 : begin 
      bus_id  <= 8'h3; 
      payload  <= {sdoid,16'h4000, 16'h2401, 16'h0,8'h0, bus_id};//ch3
      
    end
    5'h4 : begin 
      bus_id  <= 8'h4;
      payload  <= {sdoid,16'h4000, 16'h2402, 16'h0, 8'h0, bus_id};//ch4
      
    end
    5'h5 : begin
      bus_id  <= 8'h5; 
      payload  <= {sdoid,16'h4000, 16'h2402, 16'h0, 8'h0, bus_id};//ch5
      
    end
    5'h6 : begin 
      bus_id  <= 8'h6; 
      payload  <= {sdoid,16'hDEAD, 16'h0, 16'hBEEF, 8'h0, bus_id};
    ...
    5'h12 : begin bus_id  <= 8'h12; 
      payload  <= {sdoid,16'hDEAD, 16'h0, 16'hBEEF, 8'h0, bus_id};
      
    end
    5'h13 : begin bus_id  <= 8'h13;
      payload  <= {sdoid,16'hDEAD, 16'h0, 16'hBEEF, 8'h0, bus_id};
    ...
    5'h15 : begin bus_id  <= 8'h15; 
      payload  <= {sdoid,16'hDEAD, 16'h0, 16'hBEEF, 8'h0, bus_id};
      
    end
    5'h16 : begin bus_id  <= 8'h16; 
      payload  <= {sdoid,16'hDEAD, 16'h0, 16'hBEEF, 8'h0, bus_id};
      
    end
    5'h17 : begin bus_id  <= 8'h17;
      payload  <= {sdoid,16'hDEAD, 16'h0, 16'hBEEF, 8'h0, bus_id};
      
    end
    5'h18 : begin bus_id  <= 8'h18; 
      payload  <= {sdoid,16'hDEAD, 16'h0, 16'hBEEF, 8'h0, bus_id};
      
    end
    5'h19 : begin bus_id  <= 8'h19; 
      payload  <= {sdoid,16'hDEAD, 16'h0, 16'hBEEF, 8'h0, bus_id};
      
    end
    5'h1A : begin bus_id  <= 8'h1A; 
      payload  <= {sdoid,16'hDEAD, 16'h0, 16'hBEEF, 8'h0, bus_id};
      
    end
    5'h1B : begin bus_id  <= 8'h1B; 
      payload  <= {sdoid,16'hDEAD, 16'h0, 16'hBEEF, 8'h0, bus_id};
      
    end
    5'h1C : begin bus_id  <= 8'h1C;
      payload  <= {sdoid,16'hDEAD, 16'h0, 16'hBEEF, 8'h0, bus_id};
      
    end 
    5'h1D : begin bus_id  <= 8'h1D; 
      payload  <= {sdoid,16'hDEAD, 16'h0, 16'hBEEF, 8'h0, bus_id};
