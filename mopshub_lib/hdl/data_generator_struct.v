...
assign rx0 = (select_bus == 5'b00000) ? ~(rst ^ (tx0 & txgen & txmops)): 0;
assign rx1 = (select_bus == 5'b00001) ? ~(rst ^ (tx1 & txgen & txmops)): 0;
assign rx2 = (select_bus == 5'b00010) ? ~(rst ^ (tx2 & txgen & txmops)): 0;
assign rx3 = (select_bus == 5'b00011) ? ~(rst ^ (tx3 & txgen & txmops)): 0;
assign rx4 = (select_bus == 5'b00100) ? ~(rst ^ (tx4 & txgen & txmops)): 0;
assign rx5 = (select_bus == 5'b00101) ? ~(rst ^ (tx5 & txgen & txmops)): 0;
assign rx6 = (select_bus == 5'b00110) ? ~(rst ^ (tx6 & txgen & txmops)): 0;
assign rx7 = (select_bus == 5'b00111) ? ~(rst ^ (tx7 & txgen & txmops)): 0;
