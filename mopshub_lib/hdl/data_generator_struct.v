...
( 
   ...
   input   wire                      start_write_emulator, 
...
wire                     elink_delim_dbg        = 1;
wire  [75:0]             data_tra_emulator_out;
wire                     bitCLK;
wire  [75:0]             data_rec_in;
...
EMCI_Emulator #(1,1,8'b11011100,8'b00111100,1) EMCI_Emulator_gen( 
   ...
   .rst                   (rst), 
   .data_tra_out          (data_tra_emulator_out), 
...
//assign tx_elink2bit = rx_elink2bit; // test the elink_to_fifo 2 bits 
