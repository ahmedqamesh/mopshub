...
assign rx0 = (bus_cnt == 5'b0) ? ~(rst ^ (tx_mopshub & txgen & txmops)): 0;
assign rx1 = (bus_cnt == 5'b1) ? ~(rst ^ (tx_mopshub & txgen & txmops)): 0;
