...
reg                      rst_mops;
reg   [DATA_WIDTH-1:0]   bus_payload            = 76'b0100000;
...
assign rx2 = (select_bus == 5'b10) ? ~(rst ^ (tx2 & txgen & txmops)): 0;
assign rx3 = (select_bus == 5'b11) ? ~(rst ^ (tx3 & txgen & txmops)): 0;
assign rx4 = (select_bus == 5'b100) ? ~(rst ^ (tx4 & txgen & txmops)): 0;
assign rx5 = (select_bus == 5'b101) ? ~(rst ^ (tx5 & txgen & txmops)): 0;
assign rx6 = (select_bus == 5'b110) ? ~(rst ^ (tx6 & txgen & txmops)): 0;
assign rx7 = (select_bus == 5'b111) ? ~(rst ^ (tx7 & txgen & txmops)): 0;
