...
parameter 
          ...
          check_rec1         = 5'd19,
          send_ack           = 5'd20,
          Check_powering     = 5'd21,
          s1                 = 5'd22,
          finish_proc1       = 5'd23,
          rst_rec_irq_can1   = 5'd24,
          Start_read_new1    = 5'd25,
          pass_mes_to_elink1 = 5'd26,
          Wait_For_Resp      = 5'd27,
          s0                 = 5'd28,
          Break_Loop         = 5'd29,
          finishtrim         = 5'd30;
...
always @(
   csm_timer,
   csm_to_Wait_For_Resp
)
begin : csm_wait_block_proc
   csm_timeout = (csm_timer == 11'd0);
   if (csm_to_Wait_For_Resp == 1'b1) begin
      csm_next_timer = 11'd1499;  //no cycles(1500)-1=1499
   end
   else begin
