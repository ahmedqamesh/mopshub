...
begin : csm_wait_block_proc
   csm_timeout = (csm_timer == 10'd0);
   if (csm_to_RST_BUS == 1'b1) begin
      csm_next_timer = 10'd999;  //no cycles(1000)-1=999
   end
   else if (csm_to_RST_BUS1 == 1'b1) begin
      csm_next_timer = 10'd399;  //no cycles(400)-1=399
   end
   else begin
      csm_next_timer = (csm_timeout)? 10'd0: (csm_timer - 10'd1);
   end
