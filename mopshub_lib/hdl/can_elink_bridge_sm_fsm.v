...
parameter 
          ...
          Start_write_can    = 6'd6,
          rst_tra_irq_can    = 6'd7,
          pass_mes_to_can    = 6'd8,
          read_elink_mes     = 6'd9,
          assign_bus_id      = 6'd10,
          endwaitst          = 6'd11,
          Start              = 6'd12,
          Start_read_elink   = 6'd13,
          signon             = 6'd14,
          comp_bus_select    = 6'd15,
          finish_proc        = 6'd16,
          rst_all_irq_can    = 6'd17,
          check_rec1         = 6'd18,
          send_ack           = 6'd19,
          Check_Trim         = 6'd20,
          Wait_for_OSC       = 6'd21,
          ...
          power_bus          = 6'd30,
          finish_proc3       = 6'd31,
          rst_rec_irq_can2   = 6'd32,
          pass_mes_to_elink1 = 6'd33,
          Start_read_new1    = 6'd34,
          assign_bus_id1     = 6'd35,
          buffer_rec__ack    = 6'd36,
          rst_all_irq_can1   = 6'd37,
          endwaitst_trim     = 6'd38,
          rst_msg            = 6'd39,
          Wait_Suc_tra       = 6'd40,
          checkmsg_cnt       = 6'd41,
          msg_cnt1           = 6'd42,
   ...
   case (current_state) 
      ...
      Check_Trim: begin
         if (osc_auto_trim ==1) begin
            next_state = power_bus1;
            // pragma synthesis_off
            $hdsNextPath(0,24);
            // pragma synthesis_on
         end
         else if (wait_sign_in ==1) begin
      ...
      pass_mes_to_elink1: begin
         if (end_write_elink == 1) begin
            ...
            next_state = pass_mes_to_elink1;
            // pragma synthesis_off
            $hdsNextPath(0,0);
            // pragma synthesis_on
         end
      end
      Start_read_new1: begin
         next_state = pass_mes_to_elink1;
         // pragma synthesis_off
         $hdsNextPath(0,41);
         // pragma synthesis_on
      ...
      rst_all_irq_can1: begin
         next_state = Check_Trim;
         // pragma synthesis_off
         $hdsNextPath(0,44);
         // pragma synthesis_on
      end
      endwaitst_trim: begin
         next_state = rst_all_irq_can1;
         // pragma synthesis_off
         $hdsNextPath(0,45);
         // pragma synthesis_on
      end
      ...
      checkmsg_cnt: begin
         if (osc_msg_cnt ==5'h10 || irq_can_tra ==1) begin
            next_state = rst_msg;
            // pragma synthesis_off
            $hdsNextPath(0,48);
            // pragma synthesis_on
...
begin : csm_wait_block_proc
   ...
   else if (csm_to_assign_bus_id1 == 1'b1) begin
      csm_next_timer = 5'd19;  //no cycles(20)-1=19
   end
