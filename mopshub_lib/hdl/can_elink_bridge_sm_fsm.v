...
parameter 
          ...
          Wait_Resp1         = 6'd38,
          Rread_Resp1        = 6'd39,
          pass_to_elink1     = 6'd40,
          rst_rec_irq_can2   = 6'd41,
          finish_proc2       = 6'd42,
          RST_BUS1           = 6'd43,
          RST_BUS2           = 6'd44,
          Wait_Counter       = 6'd45;
...
begin : next_state_block_proc
   ...
   csm_to_s0 = 1'b0;
   csm_to_RST_BUS = 1'b0;
   csm_to_RST_BUS1 = 1'b0;
   csm_to_RST_BUS2 = 1'b0;
   csm_to_Wait_Counter = 1'b0;
   case (current_state) 
      reset: begin
         if (rst == 1)
            next_state = Start;
      ...
      ST_Start_Cnt1: begin
         ...
         csm_to_Wait_Counter = 1'b1;
      end
      ST_CountRst2: begin
         next_state = RST_BUS2;
         csm_to_RST_BUS2 = 1'b1;
      end
      s2: begin
         if (irq_can_tra ==1)
...
begin : csm_wait_block_proc
   ...
   if (csm_to_s0 == 1'b1) begin
      csm_next_timer = 9'd39;  //no cycles(40)-1=39
   end
   else if (csm_to_RST_BUS == 1'b1) begin
      csm_next_timer = 9'd79;  //no cycles(80)-1=79
   end
   else if (csm_to_RST_BUS1 == 1'b1) begin
      csm_next_timer = 9'd399;  //no cycles(400)-1=399
   end
   else if (csm_to_RST_BUS2 == 1'b1) begin
      csm_next_timer = 9'd399;  //no cycles(400)-1=399
   end
   else if (csm_to_Wait_Counter == 1'b1) begin
      csm_next_timer = 9'd79;  //no cycles(80)-1=79
   end
   else begin
