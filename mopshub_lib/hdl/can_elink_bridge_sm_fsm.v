...
parameter 
          ...
          finish_proc2       = 6'd42,
          finish_proc1       = 6'd43,
          rst_rec_irq_can1   = 6'd44,
          pass_to_elink      = 6'd45,
          Rread_Resp         = 6'd46,
          Wait_Resp          = 6'd47,
          s0                 = 6'd48,
          s5                 = 6'd49,
          rst_all_irq_can2   = 6'd50;
...
begin : next_state_block_proc
   ...
   case (current_state) 
      ...
      ST_Skip_Bus_trim: begin
         next_state = rst_all_irq_can2;
         // pragma synthesis_off
         $hdsNextPath(0,36);
         // pragma synthesis_on
      end
...
begin : clocked_block_proc
   if (!rst) begin
      ...
      current_state <= ST_Skip_Bus_trim;
      csm_timer <= 5'd0;
   end
   else 
   begin
