...
wire         cs_m;
wire         cs_p;
reg   [1:0]  data_2bit_in;
wire  [1:0]  data_2bit_in_active;
reg   [1:0]  data_2bit_in_serial;
...
wire         endwait_all2;            // Upon receiving a reset message on the CANbus. FSM goes into a known state
wire         entimeout;
...
// HDL Embedded Text Block 1 Wire_assign
// Wire_assign 1                     
initial 
  begin
  data_2bit_in           = 2'b11;
  data_2bit_in_serial    = 2'b11;
  bit_cnt                = 1'b0;
  dout1bit_r             = 1'b1;
  end
                     
assign start_read_mon         = 1'b0;
assign rl                     = 1'b1;
assign endwait_all2           = 1'b0;    // Upon receiving a reset message on the CANbus. FSM goes into a known state
assign end_cnt                = 1'b0;
assign clk_en                 = 1'b1;
assign cnt_done               = 1'b0;
assign abort                  = 1'b0;
