...
( 
   ...
   output  wire           irq_can_rec_dbg, 
   output  wire           irq_can_tra_dbg, 
...
wire  [5:0]  statedeb;
wire         swap_bits          = 0;      // 0 defaultwhen '1', the output bits will be swapped
wire         tx_efifo_full;
...
elink_core #(8'b11011100,8'b00111100,generate_mopshub) elink_core0( 
   ...
   .swap_rx_bits      (swap_bits), 
   .swap_tx_bits      (swap_bits), 
