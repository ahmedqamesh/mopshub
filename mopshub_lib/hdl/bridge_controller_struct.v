...
wire  [31:0] time_limit_trim         = 32'd10000000;   //corresponds to 25 msec if the FPGA freq is 40Mhz
...
can_elink_bridge_SM can_elink_bridge_SM0( 
   .clk                   (clk), 
   .end_bus_trim_all      (done_trim_osc_all), 
...
osc_trim_SM osc_trim_SM0( 
   ...
   .reset_irq_can_all     (reset_irq_can_trim_all), 
   .reset_irq_osc_can     (reset_irq_osc_can), 
...
assign start_write_elink = (start_write_elink_main || start_write_elink_trim) & !read_spi_mode;
...
assign reset_irq_can_all = reset_irq_can_trim_all || reset_irq_can_main_all;  
