...
wire  [31:0] time_limit            = 32'd20000000;   //corresponds to 5 sec if the FPGA freq is 40Mhz
wire  [31:0] time_limit_trim       = 32'd1000000;    //corresponds to 250 msec if the FPGA freq is 40Mhz
wire         timeoutrst;
...
can_elink_bridge_SM can_elink_bridge_SM0( 
   ...
   .timeoutrst_trim    (timeoutrst_trim), 
   .abort_mes          (abort_mes), 
...
// eb1 1                                        
assign irq_elink_tra_active = (irq_elink_tra & !osc_trim_mode);
