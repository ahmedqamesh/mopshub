...
canakari_interface canakari_interface0( 
   .abort              (abort_mes), 
   .can_rec_select     (can_rec_select), 
   .clk                (clk), 
...
// Wire_assign 1                     
assign irq_trim_bus_osc        = 1'b0;                     
assign time_limit              = 32'd50000000;   //corresponds to 5 sec if the FPGA freq is 40Mhz
assign time_limit_trim         = 32'd10000000;   //corresponds to 25 msec if the FPGA freq is 40Mhz
