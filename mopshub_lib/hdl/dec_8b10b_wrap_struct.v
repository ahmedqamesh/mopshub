...
wire  [9:0] MOPS_COMMAn       = 10'b0011111001;   // -K.28.1
wire  [9:0] MOPS_COMMAp       = 10'b1100000110;   // +K.28.1
wire  [9:0] MOPS_EOCn         = 10'b0011111010;   // -K.28.5 
wire  [9:0] MOPS_EOCp         = 10'b1100000101;   // +K.28.5 
wire  [9:0] MOPS_SOCn         = 10'b0011111000;   // -K.28.7
wire  [9:0] MOPS_SOCp         = 10'b1100000111;   // +K.28.7
wire  [9:0] SOBn              = 10'b1100001010;   //+K.28.2
wire  [9:0] SOBp              = 10'b0011110101;   //-K.28.2 //start-of-busy and end-of-busy characters
wire  [9:0] SOCn              = 10'b1100000110;   //+K.28.1 Ø¹Ø¨Ø¯Ø§ÙÙÙ �sØ§ÙÙØ¯ÙÙ
...
if (generate_mopshub == 0) 
  ...
  begin:MOPSHUB_mode 
    assign ISK_comma   = (enc10b_data_in == MOPS_COMMAp |  enc10b_data_in == MOPS_COMMAn )  ? 1: 0;
    assign ISK_soc     = (enc10b_data_in == MOPS_SOCp   |  enc10b_data_in == MOPS_SOCn   )  ? 1: 0;
    assign ISK_eoc     = (enc10b_data_in == MOPS_EOCp   |  enc10b_data_in == MOPS_EOCn   )  ? 1: 0;
    assign ISK_sob     = 0;
    assign ISK_eob     = 0;    
  end
...
begin
  ISKcode_r <=ISKcode;
  if (!rst | ISK_eob ==1)//end of busy detected 
  busy_r <= 0; 
