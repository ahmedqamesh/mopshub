...
wire  [9:0] EOBn;               //+K.28.3 
wire  [9:0] EOBp;               //-K.28.3 
wire  [9:0] EOCn;               //+K.28.6
wire  [9:0] EOCp;               //-K.28.6 end-of-chunk characters
wire        ISK_char;
wire        ISK_comma;
wire        ISK_eob;
wire        ISK_eoc;
...
wire  [1:0] ISKcode;
reg   [1:0] ISKcode_r;
wire  [9:0] SOBn;               //+K.28.2
wire  [9:0] SOBp;               //-K.28.2 //start-of-busy and end-of-busy characters
wire  [9:0] SOCn;               //+K.28.1 Ø¹Ø¨Ø¯Ø§ÙÙÙ �sØ§ÙÙØ¯ÙÙ
wire  [9:0] SOCp;               //-K.28.1
reg         busy_r;
wire        code_err;
wire        dataout_valid;
reg         dataout_valid_r;
...
// HDL Embedded Text Block 5 Wire_assign1
// Wire_assign 1                     
initial 
  begin
  dataout_valid_r   = 0;
...
assign EOBn              = 10'b1100001100;   //+K.28.3 
assign EOBp              = 10'b0011110011;   //-K.28.3 
assign EOCn              = 10'b1100001001;   //+K.28.6
assign EOCp              = 10'b0011110110;   //-K.28.6 end-of-chunk characters
assign SOBn              = 10'b1100001010;   //+K.28.2
assign SOBp              = 10'b0011110101;   //-K.28.2 //start-of-busy and end-of-busy characters
assign SOCn              = 10'b1100000110;   //+K.28.1 Ø¹Ø¨Ø¯Ø§ÙÙÙ �sØ§ÙÙØ¯ÙÙ
assign SOCp              = 10'b0011111001;   //-K.28.1
