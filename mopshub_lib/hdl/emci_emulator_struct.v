...
wire         code_err;
wire         disp_err;
reg   [4:0]  request_cycle_cnt  = 5'b0;
wire  [75:0] data_rec_out;
...
rec_elink_buf rec_elink_buf_emci( 
   .clk          (bitCLK), 
   .data_rec_in  (din_elink), 
   .buffer_en    (din_flag), 
   .rst          (rst), 
   .addr         (request_cycle_cnt), 
