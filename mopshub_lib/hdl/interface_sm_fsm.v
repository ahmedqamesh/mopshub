...
( 
   ...
   output  reg     [4:0]  can_tra_select_sig, 
   output  reg            cs_can, 
...
reg [4:0] can_tra_select_sig_cld;
...
begin : next_state_block_proc
   ...
   case (current_state) 
      ...
      accmask1: begin
         if (can_tra_select_sig_cld == n_buses)
            next_state = endinit;
         else
...
begin : clocked_block_proc
   ...
   begin
      ...
      begin
         ...
         case (current_state) 
            endinit: begin
               can_tra_select_sig_cld = 5'h0;
            end
            init_counter: begin
               can_tra_select_sig_cld = 0;
            end
            increment_counter: begin
               can_tra_select_sig_cld = can_tra_select_sig_cld + 1;
            end
            assign_tra_bus_id: begin
               can_tra_select_sig_cld = data_tra_select;
            end
            assign_bus_id: begin
               can_tra_select_sig_cld = data_tra_select;
            end
...
begin : clocked_output_proc
   can_tra_select_sig = can_tra_select_sig_cld;
end
