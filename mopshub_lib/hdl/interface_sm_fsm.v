...
begin : next_state_block_proc
   ...
   case (current_state) 
      ...
      accmask1: begin
         if (can_tra_select_sig != n_busses)
...
begin : output_block_proc
   ...
   case (current_state) 
      ...
      increment_counter: begin
         can_tra_select_sig = can_tra_select_sig+1;
      end
      RB1: begin
         read = 0;
         addr = 5'b00011 ;
      ...
      assign_tra_bus_id: begin
         can_tra_select_sig = data_tra_select;
      end
      rstirq: begin
         write = 0 ;
         cs_can = 1 ;
