-- VHDL Entity mopshub_lib.dec_8b10b.symbol
--
-- Created:
--          by - dcs.dcs (chipdev2.physik.uni-wuppertal.de)
--          at - 17:00:45 03/19/21
--
...
--
-- VHDL Architecture mopshub_lib.dec_8b10b.behavioral
--
-- Created:
--          by - dcs.dcs (chipdev2.physik.uni-wuppertal.de)
--          at - 16:04:33 04/02/21
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2018.1 (Build 12)
--
...
BEGIN
   ...
   -----------------------------------------------------------------
   output_proc_proc : PROCESS (clk, reset)
   -----------------------------------------------------------------
   BEGIN
      IF  reset = '1'  THEN
         dispin <= '0';
