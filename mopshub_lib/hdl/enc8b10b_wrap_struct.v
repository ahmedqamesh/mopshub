...
reg         encDataOutrdy_r;
reg         rst_state            = 1;
wire  [9:0] direct_data_out      = {byte,2'b0};
...
// HDL Embedded Text Block 8 enc_doutrdy
// enc_doutrdy 8  
assign enc_data_out = (enc_stream ==1) ? enc_10b_data_out : direct_data_out;
