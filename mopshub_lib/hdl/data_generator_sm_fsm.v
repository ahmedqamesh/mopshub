...
module data_generator_SM( 
   ...
   output  reg                elink_test_done,   // dbg
...
parameter 
          ...
          RESPMSG4         = 9'd311,
          END_SIGN_IN1     = 9'd312,
          ST_Wait_Suc_Tra  = 9'd313,
          ST_Wait_Suc_Rec  = 9'd314,
          s0               = 9'd315,
          ST_Loop_Cnt      = 9'd316,
          ST_Wait_Counter  = 9'd317,
          ST_Start_Sign_In = 9'd318,
          ST_Rst_Cnt       = 9'd319,
          ST_Wait_To_Act   = 9'd320,
          ST_Loop_cnt1     = 9'd321,
          ST_counter_Wait  = 9'd322,
          ST_Rst_Cnt1      = 9'd323,
          ST_Rst_Cnt2      = 9'd324,
          ST_counter_Wait1 = 9'd325,
          ST_Wait_To_Act1  = 9'd326;

reg [8:0] current_state, next_state;

// Wait State Signals
reg [17:0] csm_timer;
reg [17:0] csm_next_timer;
reg        csm_timeout;
reg        csm_to_WRITE2;
reg        csm_to_ACK8;
reg        csm_to_ACK9;
...
reg        csm_to_ST_Wait_Suc_Tra;
reg        csm_to_ST_Wait_Suc_Rec;
...
begin : next_state_block_proc
   ...
   csm_to_ST_Wait_Suc_Tra = 1'b0;
   csm_to_ST_Wait_Suc_Rec = 1'b0;
   ...
   case (current_state) 
      ...
      ST_End_Read: begin
         if (irq_can_ack ==1) begin
            next_state = ST_Wait_Suc_Tra;
            csm_to_ST_Wait_Suc_Tra = 1'b1;
         end
         else
            next_state = ST_End_Read;
      end
...
always @(
   ...
   csm_to_REQMSGWAIT78,
   csm_to_ST_Done_Wait,
   csm_to_ST_Wait_Suc_Tra,
   csm_to_ST_Wait_Suc_Rec,
...
begin : csm_wait_block_proc
   csm_timeout = (csm_timer == 18'd0);
   if (csm_to_WRITE2 == 1'b1) begin
      csm_next_timer = 18'd1499;  //no cycles(1500)-1=1499
   end
      ...
      csm_next_timer = 18'd9999;  //no cycles(10000)-1=9999
   end
   else if (csm_to_s4 == 1'b1) begin
      csm_next_timer = 18'd3999;  //no cycles(4000)-1=3999
   end
      ...
      csm_next_timer = 18'd879;  //no cycles(880)-1=879
   end
   else if (csm_to_ST_Done_Wait == 1'b1) begin
      csm_next_timer = 18'd149999;  //no cycles(150000)-1=149999
   end
   else if (csm_to_ST_Wait_Suc_Tra == 1'b1) begin
      csm_next_timer = 18'd4999;  //no cycles(5000)-1=4999
   end
   else if (csm_to_ST_Wait_Suc_Rec == 1'b1) begin
      csm_next_timer = 18'd4999;  //no cycles(5000)-1=4999
   end
   else if (csm_to_ST_Wait_Counter == 1'b1) begin
      csm_next_timer = 18'd14999;  //no cycles(15000)-1=14999
   end
   else if (csm_to_ST_Wait_To_Act == 1'b1) begin
      csm_next_timer = 18'd19999;  //no cycles(20000)-1=19999
   end
      ...
      csm_next_timer = (csm_timeout)? 18'd0: (csm_timer - 18'd1);
   end
