...
module data_generator_SM( 
   ...
   input   wire       [4:0]   sel_bus, 
   input   wire               bus_test, 
   output  reg        [4:0]   bus_cnt
);
...
parameter 
          ...
          ST_Done_Wait    = 9'd311,
          ST_Irq1         = 9'd312,
          ST_Select_Sig1  = 9'd313,
          ST_Done1        = 9'd314,
          ST_End_Read2    = 9'd315,
          ST_En_Buffer1   = 9'd316;
...
begin : next_state_block_proc
   ...
   case (current_state) 
      ...
      ST_Irq1: begin
         if (start_read_elink ==1)
            next_state = ST_Select_Sig1;
         else
            next_state = ST_Irq1;
      end
      ST_Select_Sig1: begin
