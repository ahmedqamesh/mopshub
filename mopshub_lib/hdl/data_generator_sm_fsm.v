...
module data_generator_SM( 
   ...
   input   wire               startsm,            // This dignal should start the SM and comes from TB
   ...
   output  reg                indic_sign_in,      // To indicate arrival of sign-in message
   input   wire               read_adc, 
...
begin : next_state_block_proc
   ...
   case (current_state) 
      ...
      TRIMORNOT: begin
         if (osc_auto_trim == 1)
            next_state = Notice_Sig;
         else if (osc_auto_trim == 0) begin
            next_state = SIGN_IN;
            csm_to_SIGN_IN = 1'b1;
         end
         else
