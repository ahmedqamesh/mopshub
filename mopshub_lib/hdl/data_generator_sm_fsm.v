...
parameter 
          ...
          s0                = 9'd306,
          ST_Loop_Cnt       = 9'd307,
          ST_Wait_Counter   = 9'd308,
          ST_Rst_Cnt        = 9'd309,
          ST_Wait_To_Act    = 9'd310,
          ST_Loop_cnt1      = 9'd311,
          ST_counter_Wait   = 9'd312,
          ST_Rst_Cnt1       = 9'd313,
          ST_Rst_Cnt2       = 9'd314,
          ST_counter_Wait1  = 9'd315,
          ST_Wait_To_Act1   = 9'd316,
          ST_Done1          = 9'd317,
          ST_Done_Wait1     = 9'd318,
          ST_Loop_cnt2      = 9'd319,
          ST_Rst_Cnt3       = 9'd320,
          ST_counter_Wait2  = 9'd321,
          ST_Enable_Data1   = 9'd322,
          ST_Wait_Suc_Tra2  = 9'd323,
          REQMSG7           = 9'd324,
          ST_Wait_Suc_Rec2  = 9'd325,
          RESPMSG7          = 9'd326,
          RESPMSGWAIT73     = 9'd327,
          ST_Enable_Data2   = 9'd328,
          ST_Wait_Suc_Tra3  = 9'd329,
          REQMSG8           = 9'd330,
          ST_Wait_Suc_Rec3  = 9'd331,
          RESPMSG8          = 9'd332,
          RESPMSGWAIT74     = 9'd333,
          ST_Done_Wait2     = 9'd334,
          ST_Done_Wait3     = 9'd335,
          ST_Enable_Data3   = 9'd336,
          ST_Wait_Suc_Tra4  = 9'd337,
          REQMSG9           = 9'd338,
          ST_Wait_Suc_Rec4  = 9'd339,
          RESPMSG9          = 9'd340,
          RESPMSGWAIT75     = 9'd341,
          ST_Done_Wait4     = 9'd342,
          ST_Enable_Data4   = 9'd343,
          ST_Wait_Suc_Tra5  = 9'd344,
          REQMSG10          = 9'd345,
          ST_Wait_Suc_Rec5  = 9'd346,
          RESPMSG10         = 9'd347,
          RESPMSGWAIT76     = 9'd348,
          ST_Done_Wait5     = 9'd349,
          ST_Enable_Data5   = 9'd350,
          ST_Wait_Suc_Tra6  = 9'd351,
          REQMSG11          = 9'd352,
          ST_Wait_Suc_Rec6  = 9'd353,
          RESPMSG11         = 9'd354,
          RESPMSGWAIT77     = 9'd355,
          ST_Done_Wait6     = 9'd356,
          ST_Enable_Data6   = 9'd357,
          ST_Wait_Suc_Tra7  = 9'd358,
          REQMSG12          = 9'd359,
          ST_Wait_Suc_Rec7  = 9'd360,
          RESPMSG12         = 9'd361,
          RESPMSGWAIT83     = 9'd362,
          ST_Done_Wait7     = 9'd363,
          ST_test_tx_end    = 9'd364,
          ST_En_Buffer1     = 9'd365,
          ST_End_Read1      = 9'd366,
          REQMSG5           = 9'd367,
          RESPMSGWAIT85     = 9'd368,
          ST_Wait_Suc_Rec1  = 9'd369,
          RESPMSG5          = 9'd370,
          ST_Done_Wait9     = 9'd371,
          ST_Bus_cnt2       = 9'd372,
          ST_Irq1           = 9'd373,
          ST_Enable_Data7   = 9'd374,
          ST_Wait_Suc_Tra8  = 9'd375,
          REQMSG13          = 9'd376,
          ST_Wait_Suc_Rec8  = 9'd377,
          RESPMSG13         = 9'd378,
          RESPMSGWAIT84     = 9'd379,
          ST_Done_Wait8     = 9'd380,
          ST_Enable_Data8   = 9'd381,
          ST_Wait_Suc_Tra9  = 9'd382,
          REQMSG14          = 9'd383,
          ST_Wait_Suc_Rec9  = 9'd384,
          RESPMSG14         = 9'd385,
          RESPMSGWAIT86     = 9'd386,
          ST_Done_Wait10    = 9'd387,
          ST_Enable_Data9   = 9'd388,
          ST_Wait_Suc_Tra10 = 9'd389,
          REQMSG15          = 9'd390,
          ST_Wait_Suc_Rec10 = 9'd391,
          RESPMSG15         = 9'd392,
          RESPMSGWAIT87     = 9'd393,
          ST_Done_Wait11    = 9'd394,
          ST_Enable_Data10  = 9'd395,
          ST_Wait_Suc_Tra11 = 9'd396,
          REQMSG16          = 9'd397,
          ST_Wait_Suc_Rec11 = 9'd398,
          RESPMSG16         = 9'd399,
          RESPMSGWAIT88     = 9'd400,
          ST_Done_Wait12    = 9'd401,
          ST_Enable_Data11  = 9'd402,
          ST_Wait_Suc_Tra12 = 9'd403,
          REQMSG17          = 9'd404,
          ST_Wait_Suc_Rec12 = 9'd405,
          RESPMSG17         = 9'd406,
          RESPMSGWAIT89     = 9'd407,
          ST_Done_Wait13    = 9'd408,
          ST_Enable_Data12  = 9'd409,
          ST_Wait_Suc_Tra13 = 9'd410,
          REQMSG18          = 9'd411,
          ST_Wait_Suc_Rec13 = 9'd412,
          RESPMSG18         = 9'd413,
          RESPMSGWAIT90     = 9'd414,
          ST_Done_Wait14    = 9'd415,
          ST_Rst_Cnt4       = 9'd416,
          ST_Loop_Cnt1      = 9'd417,
          ST_Wait_Counter1  = 9'd418;
...
begin : next_state_block_proc
   ...
   case (current_state) 
      ...
      ST_Loop_Cnt1: begin
         next_state = ST_Wait_Counter1;
         csm_to_ST_Wait_Counter1 = 1'b1;
      end
      ST_Wait_Counter1: begin
         if (csm_timeout)
            next_state = ST_Start_Trim;
         else
            next_state = ST_Wait_Counter1;
...
begin : csm_wait_block_proc
   ...
   if (csm_to_WRITE2 == 1'b1) begin
      ...
      csm_next_timer = 15'd2499;  //no cycles(2500)-1=2499
   end
   ...
   else if (csm_to_ST_Wait_Counter1 == 1'b1) begin
      csm_next_timer = 15'd999;  //no cycles(1000)-1=999
   end
   else begin
