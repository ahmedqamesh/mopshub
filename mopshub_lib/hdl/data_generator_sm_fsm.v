...
parameter 
          ...
          ST_Done1         = 9'd327,
          ST_Done_Wait1    = 9'd328,
          ST_Loop_cnt2     = 9'd329,
          ST_Rst_Cnt3      = 9'd330,
          ST_counter_Wait2 = 9'd331,
          ST_Enable_Data1  = 9'd332,
          ST_Wait_Suc_Tra2 = 9'd333,
          REQMSG7          = 9'd334,
          ST_Wait_Suc_Rec2 = 9'd335,
          RESPMSG7         = 9'd336,
          RESPMSGWAIT73    = 9'd337;
...
begin : csm_wait_block_proc
   ...
   if (csm_to_WRITE2 == 1'b1) begin
      ...
      csm_next_timer = 15'd9999;  //no cycles(10000)-1=9999
   end
