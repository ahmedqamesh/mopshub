...
assign  bitstream_align0 = (thCR_REVERSE_10B == 0)       ?  EDATAbitstreamSREG [9:0] ://LSB send first
                                                         {  EDATAbitstreamSREG [0],
...
assign  bitstream_align1 = (thCR_REVERSE_10B == 0)     ?    EDATAbitstreamSREG [1+9:1+0]://LSB send first
