...
( 
   ...
   output  wire           done, 
   output  wire    [7:0]  gen_edata_8bit, 
...
//Synchronized output of the elink FIFO signals  
  assign reset = !rst;
  assign gen_edata_8bit = dout_r; 
  assign delimeter = delimeter_r;
  assign gen_edata_10bit ={delimeter,gen_edata_8bit};                                   
