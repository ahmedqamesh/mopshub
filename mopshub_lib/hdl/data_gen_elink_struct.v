...
wire         code_err;
wire         counter_en;
reg   [75:0] data_gen_76bit_reg  = 76'b0;
...
assign data_gen_10bitout ={data_rec_delimiter,data_rec_8bitout}; 
assign tx_elink2bit_gen = rx_elink2bit_gen;
assign reset = !rst;  
always@(posedge bitCLK)
begin 
  if (rst)
  begin
    data_gen_76bit_reg  <= 75'b0;
  end
  if (irq_elink_rec)
  begin
    data_gen_76bit_reg  <= gen_edata_tra; 
  end 
  else
  begin
   data_gen_76bit_reg  <= data_gen_76bit_reg ; 
  end
end  
