...
wire  [9:0] data_encoder_output;
wire  [7:0] data_encoder_input;
wire        KI_signal;
wire  [9:0] enc10bit;
reg   [9:0] enc10bit_r;
...
enc_8b10b_mopshub enc_8b10b_mopshub0( 
   ...
   .ena     (data_out_rdy), 
   .ki      (KI_signal), 
   .datain  (data_encoder_input), 
   .dataout (data_encoder_output)
); 
...
begin
  ...
  begin
    if (get_data_trig  == 1) enc10bit_r <= data_encoder_output;
...
assign data_encoder_input = data_10bit_in[7:0];
