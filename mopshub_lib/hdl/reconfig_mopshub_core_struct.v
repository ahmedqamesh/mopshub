...
module reconfig_mopshub_core( 
   ...
   output  wire           partial_reconfig_id
);
...
wire  [2:0]  state_out;
wire  [6:0]  statedeb;
wire  [31:0] time_limit_in;
wire  [31:0] time_limit_out;
wire         timeoutrst_in;
wire         timeoutrst_out;
wire         tx_fifo_empty;
wire         wfull;
...
reconfig_elink_out_sm reconfig_elink_out_sm0( 
   ...
   .entimeout     (entimeout_out), 
   .read_en       (read_en), 
   .state_out     (state_out)
); 

timout_rst_module timout_rst_in( 
   .clk        (clk), 
   .entimeout  (entimeout_in), 
...
timout_rst_module timout_rst_out( 
   .clk        (clk), 
   .entimeout  (entimeout_out), 
   .time_limit (time_limit_out), 
   .rst        (rstn), 
   .timeoutrst (timeoutrst_out)
); 
...
// HDL Embedded Text Block 4 reg_assign3
// Wire_assign 1                     
assign  time_limit_in             = 32'd10000000;                     
assign  time_limit_out            = 32'd10000000;                     
