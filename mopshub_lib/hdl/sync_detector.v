...
assign  bitstream_align_array0 = (thCR_REVERSE_10B == 0) ?  EDATAbitstreamSREG [9:0] ://LSB send first
                                                         {  EDATAbitstreamSREG [0],
...
assign  bitstream_align_array1 = (thCR_REVERSE_10B == 0) ?  EDATAbitstreamSREG [1+9:1+0]://LSB send first
...
assign comma_valid_bits[0] = (bitstream_align_array0 == FEI4B_COMMAp | bitstream_align_array0== FEI4B_COMMAn) ? 1:0;
assign comma_valid_bits[1] = (bitstream_align_array1 == FEI4B_COMMAp | bitstream_align_array1== FEI4B_COMMAn) ? 1:0;
