...
module elink_interface_tra_sm( 
   ...
   input   wire           sign_in_signal, 
   input   wire           start_write_elink_can,  // request from bridge FSM
