   ...
   case (current_state) 
      ...
      Increament: begin
         if (!tx_efifo_full)
            ...
            next_state = Increament;
      end
      ST_Align_Comma: begin
         if (!tx_fifo_empty)
            next_state = ST_waittoact;
         else
            next_state = Increament;
...
begin : clocked_block_proc
   ...
   begin
      ...
      case (current_state) 
         ...
         store_WB0_DBG: begin
            addr_write_cld = 5'b00010 ;
         end
         store_WB1_DBG: begin
            addr_write_cld = 5'b00011 ;
         end
         ST_wait_can_rq_DBG: begin
            addr_write_cld = 5'b00000;
         end
         store_WB8_DBG: begin
            addr_write_cld = 5'b01010 ;
         end
         store_WB2_DBG: begin
            addr_write_cld = 5'b00100 ;
         end
         store_WB7_DBG: begin
            addr_write_cld = 5'b01001 ;
         end
         store_WB3_DBG: begin
            addr_write_cld = 5'b00101 ;
         end
         store_WB6_DBG: begin
            addr_write_cld = 5'b01000 ;
         end
         store_WB4_DBG: begin
            addr_write_cld = 5'b00110 ;
         end
         store_WB5_DBG: begin
            addr_write_cld = 5'b00111 ;
         end
         store_SOP_DBG: begin
            addr_write_cld = 5'b00001 ;
         end
         store_WB9_DBG: begin
            addr_write_cld = 5'b01011 ;
         end
         Store_Eop_DBG: begin
            addr_write_cld = 5'b01100 ;
         end
         WB0_DBG: begin
            addr_write_cld = 5'b00010 ;
         end
