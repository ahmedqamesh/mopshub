...
( 
   ...
   output  wire           power_bus_en_active, 
...
initialize_bus_control initialize_bus_control0( 
   .addr      (addr), 
   .data_init (data_init)
); 
...
//assign power_bus_en_done = 1'b1;
assign power_bus_en_active = power_bus_en;
