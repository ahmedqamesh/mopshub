...
// Instances 
fifo_upstream fifo_upstream_elink( 
   .dout        (dout_elink), 
   .full        (full_elink), 
   .empty       (empty_elink), 
   .prog_full   (prog_full), 
...
if (rst == 1)
  ...
  begin
    ...
    else if(flag_pack == 1 && din_rdy == 1 && din != {2'b01,Kchar_eop})// data
      begin
        wr_en_r   <= 1'b1;
        flag_pack <= 1'b1;
      end   
...
// HDL Embedded Text Block 4 assign_wr_en
