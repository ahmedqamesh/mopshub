...
module node_readdata_SM( 
   ...
   input   wire    [4:0]   can_rec_counter, 
   input   wire            clock, 
...
begin : next_state_block_proc
   case (current_state) 
      waitstate: begin
         if ((can_rec[0] ==1 && can_rec_counter==5'h0))
            next_state = canbus0;
         else if ((can_rec[1] ==1 && can_rec_counter==5'h1))
            next_state = canbus1;
         else if ((can_rec[2] ==1 && can_rec_counter==5'h2))
            next_state = canbus2;
         else if ((can_rec[3] ==1 && can_rec_counter==5'h3))
            next_state = canbus3;
         else if ((can_rec[4] ==1 && can_rec_counter==5'h4))
            next_state = canbus4;
         else if ((can_rec[5] ==1 && can_rec_counter==5'h5))
            next_state = canbus5;
         else if ((can_rec[6] ==1 &&can_rec_counter==5'h6 ))
            next_state = canbus6;
         else if ((can_rec[7] ==1 &&can_rec_counter==5'h7))
            next_state = canbus7;
         else if ((can_rec[8]==1  && can_rec_counter==5'h8))
            next_state = canbus8;
         else if ((can_rec[9] ==1 && can_rec_counter==5'h9))
            next_state = canbus9;
         else if ((can_rec[10] ==1 && can_rec_counter==5'hA))
            next_state = canbus10;
         else if ((can_rec[11] ==1 && can_rec_counter==5'hB))
            next_state = canbus11;
         else if ((can_rec[12]==1  && can_rec_counter==5'hC))
            next_state = canbus12;
         else if ((can_rec[13] ==1 && can_rec_counter==5'hD))
            next_state = canbus13;
         else if ((can_rec[14]==1  &&can_rec_counter==5'hE))
            next_state = canbus14;
         else if ((can_rec[15]==1 && can_rec_counter==5'hF))
            next_state = canbus15;
         else if ((can_rec[16]==1 &&can_rec_counter==5'h10))
            next_state = canbus16;
         else if ((can_rec[17] ==1 && can_rec_counter==5'h11))
            next_state = canbus17;
         else if ((can_rec[18]==1 && can_rec_counter==5'h12))
            next_state = canbus18;
         else if ((can_rec[19] ==1 &&can_rec_counter==5'h13))
            next_state = canbus19;
         else if ((can_rec[20] ==1 &&can_rec_counter==5'h14))
            next_state = canbus20;
         else if ((can_rec[21] ==1 && can_rec_counter==5'h15))
            next_state = canbus21;
         else if ((can_rec[22] ==1 && can_rec_counter==5'h16))
            next_state = canbus22;
         else if ((can_rec[23] ==1 && can_rec_counter==5'h17))
            next_state = canbus23;
         else if ((can_rec[24]==1 && can_rec_counter==5'h18))
            next_state = canbus24;
         else if ((can_rec[25] ==1 &&can_rec_counter==5'h19))
            next_state = canbus25;
         else if ((can_rec[26]==1 && can_rec_counter==5'h1A))
            next_state = canbus26;
         else if ((can_rec[27] ==1 && can_rec_counter==5'h1B))
            next_state = canbus27;
         else if ((can_rec[28] ==1 &&can_rec_counter==5'h1C))
            next_state = canbus28;
         else if ((can_rec[29] ==1 && can_rec_counter==5'h1D))
            next_state = canbus29;
         else if ((can_rec[30] ==1 && can_rec_counter==5'h1E))
            next_state = canbus30;
         else if ((can_rec[31] ==1 && can_rec_counter==5'h1F))
            next_state = canbus31;
         else
