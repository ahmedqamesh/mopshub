...
assign prescaler_init = 16'hFF;// prescalar register value gives 125000kb/s 
assign general_init = 16'hA3; // general register.first 7bits<=0 then sjw,tseg1,tseg2 gives 125000kb/s 
