...
always @(posedge clk)
  begin
   if (!rst)
      direct_data_out <= 10'b0;
  else
  begin
      //  if (reverse_stream_10b == 1)
        direct_data_out <= bitstream_align0;
     //  else
     //   direct_data_out <= {bitstream_align0[0],bitstream_align0[1],bitstream_align0[2],bitstream_align0[3],bitstream_align0[4],bitstream_align0[5],bitstream_align0[6],bitstream_align0[7],bitstream_align0[8],bitstream_align0[9]};                                  
  end
  end
...
// enc_doutrdy 8  
assign dec_data_out = (enc_stream ==1) ? HGFEDCBA : direct_data_out;
