...
wire  [7:0]  dec10b_data;
wire         direct10b_rdy;
wire         word10b_rdy;
wire  [9:0]  direct10b_data;
wire         dec10b_rdy;
...
// enc_doutrdy 8  
assign data_rdy  = (dec10b_rdy||direct10b_rdy); 
assign dec_data_out = (enc_stream ==1) ? dec10b_data : direct10b_data[7:0];
