...
dec_8b10b_wrap #(0) dec_8b10b_wrap0( 
   ...
   .RBYTECLK      (bitCLKx4), 
   .datain_valid  (word10b_align_rdy), 
   .reset         (reset), 
   .BUSY          (BUSY), 
   .HGFEDCBA      (HGFEDCBA), 
   .ISK           (ISK), 
...
pulse_pdxx_pwxx pulse_pdxx_pwxx0( 
   .clk      (bitCLK), 
   .trigger  (word10b_align_rdy), 
   .pulseout (data_rdy)
); 
...
assign word10b_align_rdy  = alignment_sreg[4]; 
