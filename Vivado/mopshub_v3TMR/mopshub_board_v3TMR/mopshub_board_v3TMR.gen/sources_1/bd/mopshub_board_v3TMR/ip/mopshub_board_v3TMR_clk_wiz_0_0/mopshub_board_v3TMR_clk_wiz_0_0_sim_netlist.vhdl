...
--               /home/dcs/git/mopshub/Vivado/mopshub_v3TMR/mopshub_board_v3TMR/mopshub_board_v3TMR.gen/sources_1/bd/mopshub_board_v3TMR/ip/mopshub_board_v3TMR_clk_wiz_0_0/mopshub_board_v3TMR_clk_wiz_0_0_sim_netlist.vhdl
...
entity mopshub_board_v3TMR_clk_wiz_0_0_mopshub_board_v3TMR_clk_wiz_0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of mopshub_board_v3TMR_clk_wiz_0_0_mopshub_board_v3TMR_clk_wiz_0_0_clk_wiz : entity is "mopshub_board_v3TMR_clk_wiz_0_0_clk_wiz";
end mopshub_board_v3TMR_clk_wiz_0_0_mopshub_board_v3TMR_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of mopshub_board_v3TMR_clk_wiz_0_0_mopshub_board_v3TMR_clk_wiz_0_0_clk_wiz is
  signal clk_elink_mopshub_board_v3TMR_clk_wiz_0_0 : STD_LOGIC;
  signal clk_elink_mopshub_board_v3TMR_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_in1_mopshub_board_v3TMR_clk_wiz_0_0 : STD_LOGIC;
  signal clk_rx_m_mopshub_board_v3TMR_clk_wiz_0_0 : STD_LOGIC;
  signal clk_rx_m_mopshub_board_v3TMR_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_tx_m_mopshub_board_v3TMR_clk_wiz_0_0 : STD_LOGIC;
  signal clk_tx_m_mopshub_board_v3TMR_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clkfbout_buf_mopshub_board_v3TMR_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_mopshub_board_v3TMR_clk_wiz_0_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_mopshub_board_v3TMR_clk_wiz_0_0,
      O => clkfbout_buf_mopshub_board_v3TMR_clk_wiz_0_0
    );
clkin1_ibufgds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_mopshub_board_v3TMR_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => clk_elink_mopshub_board_v3TMR_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_elink,
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_elink_mopshub_board_v3TMR_clk_wiz_0_0,
      O => clk_elink_mopshub_board_v3TMR_clk_wiz_0_0_en_clk
    );
clkout2_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg2(7),
      CE1 => '0',
      I0 => clk_tx_m_mopshub_board_v3TMR_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_tx_m,
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_tx_m_mopshub_board_v3TMR_clk_wiz_0_0,
      O => clk_tx_m_mopshub_board_v3TMR_clk_wiz_0_0_en_clk
    );
clkout3_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg3(7),
      CE1 => '0',
      I0 => clk_rx_m_mopshub_board_v3TMR_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_rx_m,
...
clkout3_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_rx_m_mopshub_board_v3TMR_clk_wiz_0_0,
      O => clk_rx_m_mopshub_board_v3TMR_clk_wiz_0_0_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_buf_mopshub_board_v3TMR_clk_wiz_0_0,
      CLKFBOUT => clkfbout_mopshub_board_v3TMR_clk_wiz_0_0,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_mopshub_board_v3TMR_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_elink_mopshub_board_v3TMR_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_tx_m_mopshub_board_v3TMR_clk_wiz_0_0,
      CLKOUT1B => NLW_mmcm_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clk_rx_m_mopshub_board_v3TMR_clk_wiz_0_0,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_elink_mopshub_board_v3TMR_clk_wiz_0_0_en_clk,
      CE => '1',
      D => locked_int,
      Q => seq_reg1(0),
      R => '0'
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_tx_m_mopshub_board_v3TMR_clk_wiz_0_0_en_clk,
      CE => '1',
      D => locked_int,
      Q => seq_reg2(0),
      R => '0'
...
\seq_reg3_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_rx_m_mopshub_board_v3TMR_clk_wiz_0_0_en_clk,
      CE => '1',
      D => locked_int,
      Q => seq_reg3(0),
      R => '0'
...
entity mopshub_board_v3TMR_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of mopshub_board_v3TMR_clk_wiz_0_0 : entity is true;
end mopshub_board_v3TMR_clk_wiz_0_0;

architecture STRUCTURE of mopshub_board_v3TMR_clk_wiz_0_0 is
begin
inst: entity work.mopshub_board_v3TMR_clk_wiz_0_0_mopshub_board_v3TMR_clk_wiz_0_0_clk_wiz
     port map (
      clk_elink => clk_elink,
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
