set_property SRC_FILE_INFO {cfile:/home/dcs/git/mopshub/Vivado/mopshub_v3TMR/src/constrs_1/multiboot_specifications.xdc rfile:../../../../src/constrs_1/multiboot_specifications.xdc id:1} [current_design]
set_property SRC_FILE_INFO {cfile:/home/dcs/git/mopshub/Vivado/mopshub_v3TMR/src/constrs_1/mopshub_board_16bus_v3.xdc rfile:../../../../src/constrs_1/mopshub_board_16bus_v3.xdc id:2} [current_design]
set_property SRC_FILE_INFO {cfile:/home/dcs/git/mopshub/Vivado/mopshub_v3TMR/src/constrs_1/tmr_synth.xdc rfile:../../../../src/constrs_1/tmr_synth.xdc id:3} [current_design]
...
set_property KEEP_HIERARCHY true [get_cells [get_cells -quiet -hierarchical -filter {NAME =~ "*Voter*" && IS_PRIMITIVE == false}] ]
set_property src_info {type:XDC file:3 line:8 export:INPUT save:INPUT read:READ} [current_design]
set_property KEEP_HIERARCHY true [get_cells [get_cells -quiet -hierarchical -filter {NAME =~ "*Fanout*" && IS_PRIMITIVE == false}] ]
