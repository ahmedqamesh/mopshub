...
namespace eval ::optrace {
  variable script "/home/dcs/git/mopshub/Vivado/mopshub_v3TMR/mopshub_board_v3TMR/mopshub_board_v3TMR.runs/impl_1/mopshub_board_v3TMR_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /home/dcs/git/mopshub/Vivado/mopshub_v3TMR/mopshub_board_v3TMR/mopshub_board_v3TMR.runs/synth_1/mopshub_board_v3TMR_wrapper.dcp
...
OPTRACE "link_design" START { }
  set_param project.isImplRun true
  link_design -top mopshub_board_v3TMR_wrapper -part xc7a200tfbg484-2
...
OPTRACE "init_design_write_hwdef" START { }
  write_hwdef -force -file mopshub_board_v3TMR_wrapper.hwdef
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mopshub_board_v3TMR_wrapper_opt.dcp
OPTRACE "Opt Design: write_checkpoint" END { }
OPTRACE "opt_design reports" START { REPORT }
  create_report "impl_1_opt_report_drc_0" "report_drc -file mopshub_board_v3TMR_wrapper_drc_opted.rpt -pb mopshub_board_v3TMR_wrapper_drc_opted.pb -rpx mopshub_board_v3TMR_wrapper_drc_opted.rpx"
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mopshub_board_v3TMR_wrapper_placed.dcp
OPTRACE "Place Design: write_checkpoint" END { }
OPTRACE "place_design reports" START { REPORT }
  create_report "impl_1_place_report_io_0" "report_io -file mopshub_board_v3TMR_wrapper_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file mopshub_board_v3TMR_wrapper_utilization_placed.rpt -pb mopshub_board_v3TMR_wrapper_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file mopshub_board_v3TMR_wrapper_control_sets_placed.rpt"
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mopshub_board_v3TMR_wrapper_physopt.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mopshub_board_v3TMR_wrapper_routed.dcp
OPTRACE "Route Design: write_checkpoint" END { }
OPTRACE "route_design reports" START { REPORT }
  create_report "impl_1_route_report_drc_0" "report_drc -file mopshub_board_v3TMR_wrapper_drc_routed.rpt -pb mopshub_board_v3TMR_wrapper_drc_routed.pb -rpx mopshub_board_v3TMR_wrapper_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file mopshub_board_v3TMR_wrapper_methodology_drc_routed.rpt -pb mopshub_board_v3TMR_wrapper_methodology_drc_routed.pb -rpx mopshub_board_v3TMR_wrapper_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file mopshub_board_v3TMR_wrapper_power_routed.rpt -pb mopshub_board_v3TMR_wrapper_power_summary_routed.pb -rpx mopshub_board_v3TMR_wrapper_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file mopshub_board_v3TMR_wrapper_route_status.rpt -pb mopshub_board_v3TMR_wrapper_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file mopshub_board_v3TMR_wrapper_timing_summary_routed.rpt -pb mopshub_board_v3TMR_wrapper_timing_summary_routed.pb -rpx mopshub_board_v3TMR_wrapper_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file mopshub_board_v3TMR_wrapper_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file mopshub_board_v3TMR_wrapper_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file mopshub_board_v3TMR_wrapper_bus_skew_routed.rpt -pb mopshub_board_v3TMR_wrapper_bus_skew_routed.pb -rpx mopshub_board_v3TMR_wrapper_bus_skew_routed.rpx"
...
if {$rc} {
  write_checkpoint -force mopshub_board_v3TMR_wrapper_routed_error.dcp
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  catch { write_mem_info -force -no_partial_mmi mopshub_board_v3TMR_wrapper.mmi }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force mopshub_board_v3TMR_wrapper.bit 
OPTRACE "write_bitstream" END { }
OPTRACE "write_bitstream misc" START { }
OPTRACE "read constraints: write_bitstream_post" START { }
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force mopshub_board_v3TMR_wrapper}
  catch {file copy -force mopshub_board_v3TMR_wrapper.ltx debug_nets.ltx}
