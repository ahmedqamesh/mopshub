...
################################################################
# This is a generated script based on design: mopshub_board_v3TMR
#
...
# source mopshub_board_v3TMR_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# ip_buf, mopshub_top_board_16busTMR, sem_controller_wrapper
...
set design_name mopshub_board_v3TMR
...
proc create_root_design { parentCell } {
  ...
  set rx_elink_n_0 [ create_bd_port -dir I -from 0 -to 0 rx_elink_n_0 ]
  set rx_elink_p_0 [ create_bd_port -dir I -from 0 -to 0 rx_elink_p_0 ]
  set sck_c_0 [ create_bd_port -dir O sck_c_0 ]
  set sck_m_0 [ create_bd_port -dir O sck_m_0 ]
  set shift_clk_0 [ create_bd_port -dir I -type clk shift_clk_0 ]
  ...
  set block_name mopshub_top_board_16busTMR
  ...
  connect_bd_intf_net -intf_net CLK_IN1_D_0_1 [get_bd_intf_ports clk_ext] [get_bd_intf_pins clk_wiz_0/CLK_IN1_D]

  # Create port connections
  connect_bd_net -net clk_in1_0_1 [get_bd_ports clk_sys] [get_bd_pins clk_wiz_s/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_elink [get_bd_pins clk_wiz_0/clk_elink] [get_bd_pins mopshub_top_board_16_0/clk_elink] [get_bd_pins selectio_wiz_0/clk_div_in] [get_bd_pins selectio_wiz_1/clk_div_in]
  connect_bd_net -net clk_wiz_0_clk_rx_m [get_bd_pins clk_wiz_0/clk_rx_m] [get_bd_pins selectio_wiz_0/clk_in]
  connect_bd_net -net clk_wiz_0_clk_tx_m [get_bd_pins clk_wiz_0/clk_tx_m] [get_bd_pins selectio_wiz_1/clk_in]
  connect_bd_net -net clk_wiz_1_clk_100 [get_bd_pins clk_wiz_1/clk_100] [get_bd_pins sem_controller_wrapp_0/clk_icap]
  connect_bd_net -net clk_wiz_s_clk_40 [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins clk_wiz_s/clk_40] [get_bd_pins ila_0/clk] [get_bd_pins ip_buf_0/input_wire] [get_bd_pins mopshub_top_board_16_0/clk_40] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net data_in_from_pins_n_0_1 [get_bd_ports rx_elink_n_0] [get_bd_pins selectio_wiz_0/data_in_from_pins_n]
  connect_bd_net -net data_in_from_pins_p_0_1 [get_bd_ports rx_elink_p_0] [get_bd_pins selectio_wiz_0/data_in_from_pins_p]
  ...
  connect_bd_net -net mopshub_top_board_16_0_tx_elink2bit [get_bd_pins mopshub_top_board_16_0/tx_elink2bit] [get_bd_pins selectio_wiz_1/data_out_from_device]
  connect_bd_net -net proc_sys_reset_0_mb_reset [get_bd_pins mopshub_top_board_16_0/reset] [get_bd_pins proc_sys_reset_0/mb_reset] [get_bd_pins selectio_wiz_0/io_reset] [get_bd_pins selectio_wiz_1/io_reset] [get_bd_pins sem_controller_wrapp_0/reset]
  ...
  connect_bd_net -net selectio_wiz_1_data_out_to_pins_n [get_bd_ports tx_elink_n_0] [get_bd_pins selectio_wiz_1/data_out_to_pins_n]
  connect_bd_net -net selectio_wiz_1_data_out_to_pins_p [get_bd_ports tx_elink_p_0] [get_bd_pins selectio_wiz_1/data_out_to_pins_p]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins mopshub_top_board_16_0/mopshub_id] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_bit_dout [get_bd_pins selectio_wiz_0/bitslip] [get_bd_pins xlconstant_bit/dout]
