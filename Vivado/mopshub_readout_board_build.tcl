...
proc checkRequiredFiles { origin_dir} {
  ...
  # "$origin_dir/../Vivado/mopshub_debug_board/mopshub_debug_board.srcs/sources_1/bd/mopshub_readout_bd/mopshub_readout_bd.bd" \
   "$origin_dir/../Vivado/src/constrs_1/mopshub_readout_board.xdc" \
  ]
  foreach ifile $files {
  ...
  set files [list \
   "$origin_dir/../Vivado/ip_repo/tri_mode_ethernet_mac_0.xci" \
...
set _xil_proj_name_ "mopshub_readout_board"
...
set script_file "mopshub_readout_board_build.tcl"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/src/constrs_1/mopshub_readout_board.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "mopshub_readout_board.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
if { [get_property IS_LOCKED [ get_files -norecurse mopshub_readout_bd.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/mopshub_readout_board/mopshub_readout_board.gen/sources_1/bd/mopshub_readout_bd/hdl/mopshub_readout_bd_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse mopshub_readout_bd.bd] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}

add_files -norecurse  "${origin_dir}/mopshub_readout_board/mopshub_readout_board.gen/sources_1/bd/mopshub_readout_bd/hdl/mopshub_readout_bd_wrapper.v" 
after 2000
