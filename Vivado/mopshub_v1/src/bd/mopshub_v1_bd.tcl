...
################################################################
# This is a generated script based on design: mopshub_board_v1
#
...
# source mopshub_board_v1_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# mopshub_top_board_16bus, sem_controller_wrapper
...
set design_name mopshub_board_v1
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MMCM_CLKOUT5_DIVIDE {111} \
  ...
  # Create instance: xlconstant_bit1, and set properties
  set xlconstant_bit1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlconstant_bit1 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {1} \
  ...
  connect_bd_intf_net -intf_net CLK_IN1_D_0_1 [get_bd_intf_ports clk_sys] [get_bd_intf_pins clk_wiz_s1/CLK_IN1_D]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_100 [get_bd_pins clk_wiz_0/clk_100] [get_bd_pins ila_0/clk] [get_bd_pins sem_controller_wrapp_0/clk_icap]
  ...
  connect_bd_net -net clk_wiz_s1_clk_m [get_bd_pins clk_wiz_s1/clk_m] [get_bd_pins mopshub_top_board_16_0/clk_m]
  connect_bd_net -net clk_wiz_s1_clk_rx [get_bd_pins clk_wiz_s1/clk_rx] [get_bd_pins selectio_wiz_0/clk_in]
  connect_bd_net -net clk_wiz_s1_clk_tx [get_bd_pins clk_wiz_s1/clk_tx] [get_bd_pins selectio_wiz_2/clk_in]
  connect_bd_net -net clk_wiz_s1_clk_uart [get_bd_pins clk_wiz_s1/clk_uart] [get_bd_pins mopshub_top_board_16_0/clk_uart]
  connect_bd_net -net clk_wiz_s_clk_40 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins clk_wiz_s1/clk_40] [get_bd_pins mopshub_top_board_16_0/clk_40] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_s_locked [get_bd_pins clk_wiz_s1/locked] [get_bd_pins mopshub_top_board_16_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  ...
  connect_bd_net -net xlconstant_bit1_dout [get_bd_pins mopshub_top_board_16_0/mopshub_id] [get_bd_pins xlconstant_bit1/dout]
