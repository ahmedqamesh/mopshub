...
//Date        : Tue Mar 26 14:05:55 2024
//Host        : chipdev2.physik.uni-wuppertal.de running 64-bit unknown
//Command     : generate_target mopshub_board_v1.bd
//Design      : mopshub_board_v1
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "mopshub_board_v1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mopshub_board_v1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "mopshub_board_v1.hwdef" *) 
module mopshub_board_v1
   (clk_out_n_0,
    clk_out_p_0,
    clk_sys_clk_n,
    clk_sys_clk_p,
  ...
  output clk_out_n_0;
  output clk_out_p_0;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 clk_sys CLK_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME clk_sys, CAN_DEBUG false, FREQ_HZ 200000000" *) input clk_sys_clk_n;
  ...
  output sck_c_0;
  output sck_m_0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SHIFT_CLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SHIFT_CLK_0, CLK_DOMAIN mopshub_board_v1_shift_clk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input shift_clk_0;
  input shift_data_0;
  input shift_mode_0;
  output simple_out_0;
  output tmr_out_0;
  ...
  wire clk_wiz_s1_clk_elink;
  wire clk_wiz_s1_clk_m;
  wire clk_wiz_s1_clk_rx;
  wire clk_wiz_s1_clk_tx;
  wire clk_wiz_s1_clk_uart;
  ...
  wire [0:0]selectio_wiz_2_data_out_to_pins_n;
  wire [0:0]selectio_wiz_2_data_out_to_pins_p;
  ...
  assign CLK_IN1_D_0_1_CLK_N = clk_sys_clk_n;
  assign CLK_IN1_D_0_1_CLK_P = clk_sys_clk_p;
  ...
  assign tx_elink_n_0[0] = selectio_wiz_2_data_out_to_pins_n;
  assign tx_elink_p_0[0] = selectio_wiz_2_data_out_to_pins_p;
  mopshub_board_v1_clk_wiz_0_0 clk_wiz_0
       (.clk_100(clk_wiz_0_clk_100),
        .clk_in1(clk_wiz_s_clk_40));
  mopshub_board_v1_clk_wiz_s1_0 clk_wiz_s1
       (.clk_40(clk_wiz_s_clk_40),
        .clk_elink(clk_wiz_s1_clk_elink),
        .clk_in1_n(CLK_IN1_D_0_1_CLK_N),
        .clk_in1_p(CLK_IN1_D_0_1_CLK_P),
        .clk_m(clk_wiz_s1_clk_m),
        .clk_rx(clk_wiz_s1_clk_rx),
        .clk_tx(clk_wiz_s1_clk_tx),
        .clk_uart(clk_wiz_s1_clk_uart),
        .locked(clk_wiz_s_locked));
  mopshub_board_v1_ila_0_0 ila_0
  ...
  mopshub_board_v1_mopshub_top_board_16_0_0 mopshub_top_board_16_0
       (.clk_40(clk_wiz_s_clk_40),
        .clk_elink(clk_wiz_s1_clk_elink),
        .clk_m(clk_wiz_s1_clk_m),
        ...
        .miso_c(miso_c_0_1),
        .miso_m(miso_m_0_1),
        .mopshub_id(xlconstant_bit1_dout),
  ...
  mopshub_board_v1_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(clk_wiz_s_locked),
        .ext_reset_in(xlconstant_1_dout1),
        .mb_debug_sys_rst(1'b0),
        .mb_reset(xlconstant_1_dout),
        .slowest_sync_clk(clk_wiz_s_clk_40));
  mopshub_board_v1_selectio_wiz_0_0 selectio_wiz_0
       (.bitslip(xlconstant_0_dout),
        .clk_div_in(clk_wiz_s1_clk_elink),
        .clk_in(clk_wiz_s1_clk_rx),
        .data_in_from_pins_n(rx_elink_n_0_1),
        .data_in_from_pins_p(rx_elink_p_0_1),
        .data_in_to_device(selectio_wiz_0_data_in_to_device),
        .io_reset(xlconstant_1_dout));
  mopshub_board_v1_selectio_wiz_2_0 selectio_wiz_2
       (.clk_div_in(clk_wiz_s1_clk_elink),
        .clk_in(clk_wiz_s1_clk_tx),
        .data_out_from_device(mopshub_top_board_16_0_tx_elink2bit),
        .data_out_to_pins_n(selectio_wiz_2_data_out_to_pins_n),
        .data_out_to_pins_p(selectio_wiz_2_data_out_to_pins_p),
        .io_reset(xlconstant_1_dout));
  mopshub_board_v1_sem_controller_wrapp_0_0 sem_controller_wrapp_0
       (.clk_icap(clk_wiz_0_clk_100),
        .reset(xlconstant_1_dout),
  ...
  mopshub_board_v1_xlconstant_1_0 xlconstant_1
       (.dout(xlconstant_1_dout1));
  mopshub_board_v1_xlconstant_bit_0 xlconstant_bit
       (.dout(xlconstant_0_dout));
  mopshub_board_v1_xlconstant_bit1_0 xlconstant_bit1
       (.dout(xlconstant_bit1_dout));
endmodule
