...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets mopshub_board_v3_i/clk_wiz_s/inst/clk_in1_mopshub_board_v3_clk_wiz_s_0]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets mopshub_board_v3_i/mopshub_top_board_16_0/inst/seu_shift_combined0/clk]
set_false_path -from [get_clocks clk_40_mopshub_board_v3_clk_wiz_s_0] -to [get_clocks clk_uart_mopshub_board_v3_clk_wiz_s_0] 
set_false_path -from [get_clocks clk_uart_mopshub_board_v3_clk_wiz_s_0] -to [get_clocks clk_40_mopshub_board_v3_clk_wiz_s_0]
set_false_path -from [get_clocks clk_40_mopshub_board_v3_clk_wiz_s_0] -to [get_clocks clk_100_mopshub_board_v3_clk_wiz_0_0] 
set_false_path -from [get_clocks clk_100_mopshub_board_v3_clk_wiz_0_0] -to [get_clocks clk_40_mopshub_board_v3_clk_wiz_s_0]
