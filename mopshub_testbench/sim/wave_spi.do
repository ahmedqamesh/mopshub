...
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/data_generator0/txgen
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/data_generator0/test_simult
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/data_generator0/custommsg
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/rx0
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/tx0
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/mopshub0/irq_can_rec
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/mopshub0/irq_can_tra
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/data_generator0/bus_dec_data
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/mopshub0/data_rec_uplink
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/data_generator0/start_write_emulator_spi
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/data_generator0/end_write_emulator_spi
add wave -noupdate -expand -group CAN_Rx -radix binary /tb_mopshub_top/mopshub0/mopshub_core0/bridge_controller0/canakari_interface0/addr_can
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/mopshub0/mopshub_core0/bridge_controller0/canakari_interface0/end_read
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/mopshub0/elink_core0/start_write_elink
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/mopshub0/elink_core0/end_write_elink
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/mopshub0/mopshub_core0/bridge_controller0/reset_irq_can_done
add wave -noupdate -expand -group CAN_Rx /tb_mopshub_top/mopshub0/elink_core0/data_tra_10bitin
...
WaveRestoreCursors {{Cursor 1} {594240 ns} 0} {{Cursor 2} {2417923 ns} 0}
