...
add wave -noupdate -expand -group Power /tb_mopshub_top/info_debug_sig
...
add wave -noupdate -expand -group Power /tb_mopshub_top/mopshub0/control_bus0/txdat
add wave -noupdate -expand -group Power /tb_mopshub_top/mopshub0/control_bus0/rxdat
add wave -noupdate -expand -group Power /tb_mopshub_top/mopshub0/control_bus0/w_Master_TX_Ready
...
add wave -noupdate -expand -group Power /tb_mopshub_top/mopshub0/control_bus0/o_RX_DV
add wave -noupdate -expand -group Power /tb_mopshub_top/mopshub0/control_bus0/transceive
add wave -noupdate -expand -group Power /tb_mopshub_top/mopshub0/miso_c
...
WaveRestoreCursors {{Cursor 1} {501768 ns} 0} {{Cursor 2} {20179227 ns} 0}
...
update
WaveRestoreZoom {132726 ns} {327437 ns}
