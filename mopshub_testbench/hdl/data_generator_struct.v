...
data_generator_sm data_generator_SM0( 
   ...
   .test_tx_end              (test_tx_end), 
   .test_tx_start            (test_tx_start), 
   .test_advanced_start      (costum_msg_start), 
   .test_advanced_end        (costum_msg_end), 
   .tx_mopshub               (tx_mopshub), 
   .rx_mopshub               (rx_mopshub), 
   .test_advanced            (test_advanced), 
...
//assign sim_failures = can_bus_activity_wrapper0.failures; 
