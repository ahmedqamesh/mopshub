...
mopshub_decoder mopshub_decoder_emulator( 
   .clk                   (clk), 
...
begin
  ...
  case (adc_ch)
    ...
    5'h12 : payload  <= {16'h4000, 16'h2410};
    5'h13 : payload  <= {16'h4000, 16'h2411};
    5'h14 : payload  <= {16'h4000, 16'h2412};
    5'h15 : payload  <= {16'h4000, 16'h2413};
    5'h16 : payload  <= {16'h4000, 16'h2414};
    5'h17 : payload  <= {16'h4000, 16'h2415};
    5'h18 : payload  <= {16'h4000, 16'h2416};
    5'h19 : payload  <= {16'h4000, 16'h2417};
    5'h1A : payload  <= {16'h4000, 16'h2418};
    5'h1B : payload  <= {16'h4000, 16'h2419};
    5'h1C : payload  <= {16'h4000, 16'h241A};
    5'h1D : payload  <= {16'h4000, 16'h241B};
    5'h1E : payload  <= {16'h4000, 16'h241C};
    5'h1F : payload  <= {16'h4000, 16'h241D};
    5'h20 : payload  <= {16'h4000, 16'h241E};
    5'h21 : payload  <= {16'h4000, 16'h241F};
    5'h22 : payload  <= {16'h4000, 16'h2420};
    5'h23 : payload  <= {16'h4000, 16'h2421};
    5'h24 : payload  <= {16'h4000, 16'h2422};
    5'h25 : payload  <= {16'h4000, 16'h2423};
    5'h26 : payload  <= {16'h4000, 16'h2424};
    5'h27 : payload  <= {16'h4000, 16'h2425};        
    default: 
    begin 
      payload  <= {16'h0, 16'h0};
    end    
