...
wire        buffer_en3        = 1'b0;   // enable signal
...
buffer_tristate_busid buffer_tristate_busid0( 
   ...
   .data_tra_in3 (bus_loop_cnt), 
   .buffer_en0   (ext_trim_mops), 
   .buffer_en1   (sel_bus), 
   .buffer_en2   (buffer_en2), 
   .buffer_en3   (buffer_en3), 
...
assign rx_mopshub0 = (test_simult== 1'b1 || select_bus == 5'd0) ? ~(rst ^ (tx_mopshub0 & txgen & txmops)): 0;

assign rx_mopshub1 = (test_simult== 1'b1 || select_bus == 5'd1) ? ~(rst ^ (tx_mopshub1 & txgen & txmops)): 0;
assign rx_mopshub2 = (test_simult== 1'b1 || select_bus == 5'd2) ? ~(rst ^ (tx_mopshub2 & txgen & txmops)): 0;
...
assign rxdec       =  (test_simult== 1'b0) ? rx_mopshub: 0;
assign rxmops      =  (test_simult== 1'b0) ? rx_mopshub: 0;
...
assign tx_mopshub  =(test_advanced == 1) ?  txdec: 
                     ~(rst ^ (tx_mopshub0 & tx_mopshub1 & tx_mopshub2 & tx_mopshub3 & tx_mopshub4  & tx_mopshub5 & tx_mopshub6 & tx_mopshub7 
