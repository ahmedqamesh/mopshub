//
// Module mopshub_testbench.mopshub_tb_monitor_sm.fsm
//
// Created:
//          by - dcs.dcs (chipdev2.physik.uni-wuppertal.de)
//          at - 15:34:33 02/28/24
//
// Generated by Mentor Graphics' HDL Designer(TM) 2019.4 (Build 4)
//
`resetall
`timescale 1ns/10ps
module mopshub_tb_monitor_sm( 
   // Port Declarations
   // Port Declarations
   // Port Declarations
   // Port Declarations
   ...
   input   wire               sign_on_sig,                 // This dignal should start the SM and comes from TB
   ...
   output  reg        [75:0]  data_rec_decoder_spi, 
   ...
   input   wire       [75:0]  data_tra_mon_decoder_spi, 
   input   wire       [75:0]  data_tra_power_decoder_spi
);
...
parameter 
          ...
          RESPMSG75         = 8'd93,
          _Wait8            = 8'd94,
          ST_Enable_Data16  = 8'd95,
          ST_Wait_Suc_Tra21 = 8'd96,
          REQMSG25          = 8'd97,
          ST_Wait_Suc_Rec20 = 8'd98,
          RESPMSG25         = 8'd99,
          RESPMSGWAIT97     = 8'd100,
          ST_Done_Wait22    = 8'd101,
          s3                = 8'd102,
          s4                = 8'd103,
          _Wait6            = 8'd104,
          wait_sign_on      = 8'd105,
          ...
          s21               = 8'd153,
          s30               = 8'd154,
          ST_Wait_Suc_Rec21 = 8'd155,
          ST_Enable_Data17  = 8'd156,
          RESPMSGWAIT98     = 8'd157,
          ST_Wait_Suc_Tra22 = 8'd158,
          RESPMSG26         = 8'd159,
          ST_Done_Wait23    = 8'd160,
          REQMSG26          = 8'd161,
          Mon_spi           = 8'd162,
          RESPMSG78         = 8'd163,
          Power_sPI         = 8'd164,
          RESPMSG79         = 8'd165,
          Reconfig          = 8'd166,
          ST_Done_Wait24    = 8'd167,
          ST_Enable_Data15  = 8'd168,
          ST_Wait_Suc_Tra20 = 8'd169,
          REQMSG24          = 8'd170,
          ST_Wait_Suc_Rec19 = 8'd171,
          RESPMSGWAIT96     = 8'd172,
          RESPMSG24         = 8'd173;
...
reg        csm_to_s11;
reg        csm_to_s17;
reg        csm_to_RESPMSGWAIT98;
reg        csm_to_ST_Wait_Suc_Tra22;
reg        csm_to_ST_Done_Wait23;
reg        csm_to_Mon_spi;
reg        csm_to_Power_sPI;
reg        csm_to_Reconfig;
reg        csm_to_ST_Done_Wait24;
...
begin : next_state_block_proc
   ...
   csm_to_s11 = 1'b0;
   csm_to_s17 = 1'b0;
   csm_to_RESPMSGWAIT98 = 1'b0;
   csm_to_ST_Wait_Suc_Tra22 = 1'b0;
   csm_to_ST_Done_Wait23 = 1'b0;
   csm_to_Mon_spi = 1'b0;
   csm_to_Power_sPI = 1'b0;
   csm_to_Reconfig = 1'b0;
   csm_to_ST_Done_Wait24 = 1'b0;
   csm_to_ST_Wait_Suc_Tra20 = 1'b0;
   csm_to_RESPMSGWAIT96 = 1'b0;
   case (current_state) 
      ST_Reset: begin
         if (sign_on_sig == 1) begin
            next_state = wait_sign_on;
            csm_to_wait_sign_on = 1'b1;
         end
         else
            next_state = ST_Reset;
      end
      ...
      ST_Done_Wait20: begin
         next_state = ST_Done_Wait24;
         csm_to_ST_Done_Wait24 = 1'b1;
      end
      READ68: begin
      ...
      REQMSG8: begin
         if (data_rec_uplink[75:68] == 8'h21 ||data_rec_uplink[75:68] == 8'h20) begin
            next_state = Mon_spi;
            csm_to_Mon_spi = 1'b1;
         end
         else if (data_rec_uplink[75:68] ==8'h31 ||data_rec_uplink[75:68] ==8'h30) begin
            next_state = Power_sPI;
            csm_to_Power_sPI = 1'b1;
         end
         else if (data_rec_uplink[75:68] == 8'h10) begin
            next_state = Reconfig;
            csm_to_Reconfig = 1'b1;
         end
         else begin
            next_state = CAN;
            csm_to_CAN = 1'b1;
      ...
      s30: begin
         next_state = ST_Enable_Data17;
      end
      ST_Wait_Suc_Rec21: begin
         next_state = RESPMSGWAIT98;
         csm_to_RESPMSGWAIT98 = 1'b1;
      end
      ST_Enable_Data17: begin
         if (end_write_emulator_spi ==1) begin
            next_state = ST_Wait_Suc_Tra22;
            csm_to_ST_Wait_Suc_Tra22 = 1'b1;
         end
         else
            next_state = ST_Enable_Data17;
      end
      RESPMSGWAIT98: begin
         if (csm_timeout)
            next_state = RESPMSG26;
         else
            next_state = RESPMSGWAIT98;
      end
      ST_Wait_Suc_Tra22: begin
         if (csm_timeout)
            next_state = REQMSG26;
         else
            next_state = ST_Wait_Suc_Tra22;
      ...
      RESPMSG26: begin
         next_state = ST_Done_Wait23;
         csm_to_ST_Done_Wait23 = 1'b1;
      end
      ST_Done_Wait23: begin
         next_state = s29;
         csm_to_s29 = 1'b1;
      end
      REQMSG26: begin
         next_state = ST_Wait_Suc_Rec21;
      end
      Mon_spi: begin
         if (csm_timeout)
            next_state = RESPMSG78;
         else
            next_state = Mon_spi;
      end
      RESPMSG78: begin
...
begin : output_block_proc
   ...
   case (current_state) 
      ...
      ST_Enable_Data14: begin
         data_rec_decoder_spi = {1'b0, 3'h2,4'h0,4'h0,64'h180DBEEFDEADBEAF};
      ...
      ST_Enable_Data16: begin
         data_rec_decoder_spi= {1'b0, 3'h3,8'h0,64'hDEADBEEFDEADBEAF};
         start_write_emulator_spi = 1;
         test_spi = 1'b1;
      end
      ST_Wait_Suc_Tra21: begin
      ...
      READ73: begin
         start = 1;
         custommsg = 1;
         customcanid = {4'hC,7'h8};
         data = {counter8bit_reg_cld,56'h0A0A0A0A0A0A00};
      end
      s15: begin
         reqmsg = 1 ;
      end
      ...
      ST_Enable_Data17: begin
         data_rec_decoder_spi= {1'b0, 3'h3,4'h1,4'h0,64'hDEADBEEFDEADBEAF};
         start_write_emulator_spi = 1;
         test_spi = 1'b1;
      end
      RESPMSGWAIT98: begin
      ...
      ST_Enable_Data15: begin
         data_rec_decoder_spi = {1'b0, 3'h2,4'h1,4'h0,64'h180DBEEFDEADBEAF};
         start_write_emulator_spi = 1;
         test_spi = 1'b1;
      end
      ST_Wait_Suc_Tra20: begin
...
begin : clocked_block_proc
   ...
   begin
      ...
      case (current_state) 
         ...
         ST_Wait_Suc_Tra19: begin
            requestreg_cld <=  data_tra_mon_spi;
         end
         REQMSG23: begin
            requestreg_cld <=  data_tra_mon_spi;
         end
         RESPMSG23: begin
            responsereg_cld <= data_tra_mon_decoder_spi;
         end
         RESPMSGWAIT95: begin
            responsereg_cld <= data_tra_mon_decoder_spi;
         end
         ...
         ST_Wait_Suc_Tra21: begin
            requestreg_cld <=  data_tra_power_spi;
         end
         REQMSG25: begin
            requestreg_cld <=  data_tra_power_spi;
         end
         RESPMSG25: begin
            responsereg_cld <= data_tra_power_spi;
         end
         RESPMSGWAIT97: begin
            responsereg_cld <= data_tra_power_spi;
         end
         ...
         Mon_spi: begin
            responsereg_cld <= {data_tra_mon_decoder_spi[75:44],data_rec_uplink[43:0]};
         end
         RESPMSG78: begin
            responsereg_cld <= {data_tra_mon_decoder_spi[75:44],data_rec_uplink[43:0]};
         end
         Power_sPI: begin
            responsereg_cld <= {data_tra_power_decoder_spi[75:44],data_rec_uplink[43:0]};
         end
         RESPMSG79: begin
            responsereg_cld <= {data_tra_power_decoder_spi[75:44],data_rec_uplink[43:0]};
         end
...
always @(
   ...
   csm_to_s11,
   csm_to_s17,
   csm_to_RESPMSGWAIT98,
   csm_to_ST_Wait_Suc_Tra22,
   csm_to_ST_Done_Wait23,
   csm_to_Mon_spi,
   csm_to_Power_sPI,
   csm_to_Reconfig,
   csm_to_ST_Done_Wait24,
...
begin : csm_wait_block_proc
   ...
   else if (csm_to_wait_sign_on == 1'b1) begin
      csm_next_timer = 17'd49999;  //no cycles(50000)-1=49999
   end
   ...
   else if (csm_to_RESPMSGWAIT98 == 1'b1) begin
      csm_next_timer = 17'd1499;  //no cycles(1500)-1=1499
   end
   else if (csm_to_ST_Wait_Suc_Tra22 == 1'b1) begin
      csm_next_timer = 17'd999;  //no cycles(1000)-1=999
   end
   else if (csm_to_ST_Done_Wait23 == 1'b1) begin
      csm_next_timer = 17'd14999;  //no cycles(15000)-1=14999
   end
   else if (csm_to_Mon_spi == 1'b1) begin
      csm_next_timer = 17'd13999;  //no cycles(14000)-1=13999
   end
   else if (csm_to_Power_sPI == 1'b1) begin
      csm_next_timer = 17'd13999;  //no cycles(14000)-1=13999
   end
   else if (csm_to_Reconfig == 1'b1) begin
      csm_next_timer = 17'd1;  //no cycles(2)-1=1
   end
   else if (csm_to_ST_Done_Wait24 == 1'b1) begin
      csm_next_timer = 17'd14999;  //no cycles(15000)-1=14999
   end
...
endmodule // mopshub_tb_monitor_sm
