//
// Module mopshub_testbench.mopshub_tb_can_driver.struct
//
// Created:
//          by - dcs.dcs (chipdev2.physik.uni-wuppertal.de)
//          at - 16:59:29 11/01/23
//
...
always@(posedge clk_mops)
  if (!rst) rst_mops <=0;
  else 
    begin
      if (ext_rst_mops==1) rst_mops <=0;
      else rst_mops <=1; 
    end
...
//assign rx_mopshub0 = (test_simult== 1'b1 || select_bus == 5'd0) ? ~(rst ^ (tx_mopshub0 & txgen & tx0_mops1)): 0;
//assign rx_mopshub1 = (test_simult== 1'b1 || select_bus == 5'd1) ? ~(rst ^ (tx_mopshub1 & txgen & tx1_mops1)): 0;
...
assign rxdec       =  (test_simult== 1'b0 || random1000) ? rx_mopshub: 0;
...
endmodule // mopshub_tb_can_driver
