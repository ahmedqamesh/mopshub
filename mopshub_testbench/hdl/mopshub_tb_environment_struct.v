//
// Module mopshub_testbench.mopshub_tb_environment.struct
//
// Created:
//          by - dcs.dcs (chipdev2.physik.uni-wuppertal.de)
//          at - 15:18:55 05/15/24
//
...
wire         test_spi;
wire  [75:0] data_tra_mon_driver_spi;
wire  [75:0] data_tra_power_driver_spi;
...
mopshub_tb_can_decoder CANbus_decoder0( 
   .clk          (clk_mops), 
   .rst          (rst), 
   .rx           (rxdec), 
...
mopshub_tb_can_driver mopshub_tb_can_driver0( 
   .bus_cnt       (bus_cnt), 
...
mopshub_tb_canframe_generator mopshub_tb_canframe_generator0( 
   .clk           (clk_mops), 
   .clk_low       (clk_bus), 
   .rst_n         (rst), 
   .start         (start), 
...
mopshub_tb_elink_generator mopshub_tb_elink_driver0( 
   .clk                       (clk), 
   .clk_elink                 (clk_elink), 
   .data_rec_driver           (data_rec_driver), 
   .data_rec_driver_spi       (data_rec_driver_spi), 
   .rst                       (rst), 
   ...
   .data_tra_driver           (data_tra_driver), 
   .data_tra_mon_driver_spi   (data_tra_mon_driver_spi), 
   .data_tra_power_driver_spi (data_tra_power_driver_spi), 
...
mopshub_tb_monitor_sm mopshub_tb_monitor_sm0( 
   .clk                        (clk), 
   .rst                        (rst), 
   ...
   .rx_mopshub                 (rx_mopshub), 
   .test_advanced              (test_advanced), 
   .data_rec_decoder_spi       (data_rec_driver_spi), 
   ...
   .data_tra_decoder           (data_tra_driver), 
   .random1000                 (random1000), 
   .sendran                    (sendran), 
   .nextran                    (nextran), 
   .doneran                    (doneranwire), 
   ...
   .data_tra_mon_decoder_spi   (data_tra_mon_driver_spi), 
   .data_tra_power_decoder_spi (data_tra_power_driver_spi)
); 

mopshub_tb_scoreboard_wrapper mopshub_tb_scoreboard_wrapper0( 
   .clk                   (clk), 
   .rst                   (rst), 
   .bus_id                (bus_id), 
   .n_buses               (n_buses), 
...
mopshub_tb_uartframe_generator mopshub_tb_uartframe_generator0( 
   .rst           (rst), 
   .clk           (clk), 
   .clk_uart      (clk_uart), 
...
//control Signals
initial data_rec_driver =76'b0;
assign txdec_active = ^(txdec &tx_emulator);
assign sim_failures = mopshub_tb_scoreboard_wrapper0.mopshub_tb_scoreboard0.failures; 
assign bus_loop_cnt = (osc_auto_trim_mopshub  == 1'b1)? bus_cnt_power:data_out_counter[4:0];
assign counter8bit_limit = 8'd2;
assign response_cld = {data_tra_power_driver_spi[75:44],data_rec_uplink[43:0]};
// data_loader 1
assign sdoid  = {SDO_TX,can_nodeid}; 
assign bus_id = {3'h0,select_bus};
always @(posedge clk)
begin
  if(!rst) data_rec_driver <= {sdoid,32'h0, bus_id};
  else
  case (select_bus)
    5'h0  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h1  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h2  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h3  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h4  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h5  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h6  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h7  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h8  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h9  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'hA  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'hB  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'hC  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'hD  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'hE  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'hF  : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h10 : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h11 : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h12 : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h13 : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h14 : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h15 : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h16 : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h17 : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h18 : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h19 : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h1A : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h1B : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h1C : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h1D : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h1E : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    5'h1F : data_rec_driver  <= {sdoid,payload,bus_id, 8'h0,16'h0};
    default: data_rec_driver  <=  {sdoid,56'h0, bus_id, 8'h0,16'h0};    
  endcase 
end                                            
...
endmodule // mopshub_tb_environment
