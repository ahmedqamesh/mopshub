...
parameter 
          ...
          RESPMSG15         = 8'd47,
          RESPMSGWAIT87     = 8'd48,
          ST_Done_Wait11    = 8'd49,
          ST_Enable_Data10  = 8'd50,
          ST_Wait_Suc_Tra11 = 8'd51,
          REQMSG16          = 8'd52,
          ST_Wait_Suc_Rec11 = 8'd53,
          RESPMSG16         = 8'd54,
          RESPMSGWAIT88     = 8'd55,
          ST_Done_Wait12    = 8'd56,
          ST_Enable_Data11  = 8'd57,
          ST_Wait_Suc_Tra12 = 8'd58,
          REQMSG17          = 8'd59,
          ST_Wait_Suc_Rec12 = 8'd60,
          RESPMSG17         = 8'd61,
          RESPMSGWAIT89     = 8'd62,
          ST_Done_Wait13    = 8'd63,
          ST_Wait_Suc_Tra14 = 8'd64,
          ST_Done_Wait15    = 8'd65,
          ST_En_Buffer3     = 8'd66,
          ST_End_Read3      = 8'd67,
          REQMSG20          = 8'd68,
          RESPMSGWAIT92     = 8'd69,
          ST_Wait_Suc_Rec15 = 8'd70,
          RESPMSG20         = 8'd71,
          ST_Bus_cnt4       = 8'd72,
          ST_start_test2    = 8'd73,
          ST_Wait_Suc_Tra16 = 8'd74,
          ST_Done_Wait17    = 8'd75,
          ST_En_Buffer4     = 8'd76,
          ST_End_Read4      = 8'd77,
          REQMSG21          = 8'd78,
          RESPMSGWAIT93     = 8'd79,
          ST_Wait_Suc_Rec16 = 8'd80,
          RESPMSG21         = 8'd81,
          ST_Bus_cnt5       = 8'd82,
          ST_start_test3    = 8'd83,
          ST_Wait_Suc_Tra17 = 8'd84,
          ST_Done_Wait18    = 8'd85,
          READ72            = 8'd86,
          ACK147            = 8'd87,
          ACK148            = 8'd88,
          RESPMSGWAIT78     = 8'd89,
          ...
          _Wait3            = 8'd94,
          _Wait4            = 8'd95,
          ST_Enable_Data14  = 8'd96,
          ST_Wait_Suc_Tra19 = 8'd97,
          REQMSG23          = 8'd98,
          ST_Wait_Suc_Rec18 = 8'd99,
          RESPMSG23         = 8'd100,
          RESPMSGWAIT95     = 8'd101,
          ST_Done_Wait20    = 8'd102,
          _Wait7            = 8'd103,
          READ68            = 8'd104,
          READ69            = 8'd105,
          READ70            = 8'd106,
          ...
          ACK151            = 8'd108,
          ACK152            = 8'd109,
          RESPMSGWAIT80     = 8'd110,
          REQMSG76          = 8'd111,
          RESPMSG75         = 8'd112,
          _Wait5            = 8'd113,
          ST_Enable_Data15  = 8'd114,
          ST_Wait_Suc_Tra20 = 8'd115,
          REQMSG24          = 8'd116,
          ST_Wait_Suc_Rec19 = 8'd117,
          RESPMSG24         = 8'd118,
          RESPMSGWAIT96     = 8'd119,
          ST_Done_Wait21    = 8'd120,
          _Wait9            = 8'd121,
          _Wait8            = 8'd122,
          Wait              = 8'd123,
          rst_Cnt           = 8'd124,
          ST_Set_DATA11     = 8'd125,
          ST_Set_DATA12     = 8'd126,
          ST_Set_DATA13     = 8'd127,
          ST_Set_DATA14     = 8'd128,
          ST_Enable_Data16  = 8'd129,
          ST_Wait_Suc_Tra21 = 8'd130,
          REQMSG25          = 8'd131,
          ST_Wait_Suc_Rec20 = 8'd132,
          RESPMSG25         = 8'd133,
          RESPMSGWAIT97     = 8'd134,
          ST_Done_Wait22    = 8'd135,
          _Wait10           = 8'd136,
          s0                = 8'd137,
          s1                = 8'd138,
          s3                = 8'd139,
...
begin : next_state_block_proc
   ...
   case (current_state) 
      ...
      ST_WAIT: begin
         ...
         else if (test_uart_core ==1) begin
            next_state = s0;
            csm_to_s0 = 1'b1;
         end
         else
...
begin : csm_wait_block_proc
   ...
   if (csm_to_READ65 == 1'b1) begin
      ...
      csm_next_timer = 16'd299;  //no cycles(300)-1=299
   end
