...
module data_generator_SM( 
   ...
   output  reg                rand_msg_start, 
   output  reg                rand_msg_end, 
...
parameter 
          ...
          Start             = 9'd271,
          ST_Wait_Suc_Rec17 = 9'd272,
          RESPMSGWAIT94     = 9'd273,
          ST_start_test4    = 9'd274,
          RESPMSG22         = 9'd275,
          REQMSG22          = 9'd276,
          ST_En_Buffer5     = 9'd277,
          ST_Done_Wait19    = 9'd278,
          ST_End_Read5      = 9'd279,
          ST_Wait_Suc_Tra18 = 9'd280,
          end_rand          = 9'd281,
          READ72            = 9'd282,
          ACK147            = 9'd283,
          ACK148            = 9'd284,
          REQMSGWAIT74      = 9'd285,
          RESPMSGWAIT78     = 9'd286,
          REQMSG74          = 9'd287,
          RESPMSG73         = 9'd288;
...
reg        csm_to_ST_Wait_Suc_Rec17;
reg        csm_to_RESPMSGWAIT94;
reg        csm_to_ST_Done_Wait19;
reg        csm_to_ST_Wait_Suc_Tra18;
reg        csm_to_READ72;
reg        csm_to_ACK147;
reg        csm_to_ACK148;
reg        csm_to_REQMSGWAIT74;
...
begin : next_state_block_proc
   ...
   csm_to_ST_Wait_Suc_Rec17 = 1'b0;
   csm_to_RESPMSGWAIT94 = 1'b0;
   csm_to_ST_Done_Wait19 = 1'b0;
   csm_to_ST_Wait_Suc_Tra18 = 1'b0;
   csm_to_READ72 = 1'b0;
   csm_to_ACK147 = 1'b0;
   csm_to_ACK148 = 1'b0;
   csm_to_REQMSGWAIT74 = 1'b0;
   ...
   case (current_state) 
      ...
      ST_Wait_To_Act1: begin
         if (csm_timeout && (tx_mopshub ==1 & rx_mopshub ==1))
            next_state = END_ADC;
         else
            next_state = ST_Wait_To_Act1;
      end
      ...
      Start: begin
         next_state = ST_start_test4;
      end
      ST_Wait_Suc_Rec17: begin
         if (csm_timeout && (txdec == 0)) begin
            next_state = RESPMSGWAIT94;
            csm_to_RESPMSGWAIT94 = 1'b1;
         end
         else
            next_state = ST_Wait_Suc_Rec17;
      end
      RESPMSGWAIT94: begin
         if (csm_timeout)
            next_state = RESPMSG22;
         else
            next_state = RESPMSGWAIT94;
      end
      ST_start_test4: begin
         if (start_read_elink ==1 || end_write_emulator ==1)
            next_state = ST_En_Buffer5;
         else
            next_state = ST_start_test4;
      end
      RESPMSG22: begin
         next_state = ST_Done_Wait19;
         csm_to_ST_Done_Wait19 = 1'b1;
      end
      REQMSG22: begin
         next_state = ST_Wait_Suc_Rec17;
         csm_to_ST_Wait_Suc_Rec17 = 1'b1;
      end
      ST_En_Buffer5: begin
         next_state = ST_End_Read5;
      end
      ST_Done_Wait19: begin
         if (csm_timeout)
            next_state = end_rand;
         else
            next_state = ST_Done_Wait19;
      ...
      ST_End_Read5: begin
         next_state = ST_Wait_Suc_Tra18;
         csm_to_ST_Wait_Suc_Tra18 = 1'b1;
      end
      ST_Wait_Suc_Tra18: begin
         if (csm_timeout)
            next_state = REQMSG22;
         else
            next_state = ST_Wait_Suc_Tra18;
      ...
      READ72: begin
         if (csm_timeout && (tx_mopshub == 0)) begin
            next_state = REQMSGWAIT74;
            csm_to_REQMSGWAIT74 = 1'b1;
         end
         else
            next_state = READ72;
      end
...
always @(
   ...
   csm_to_ST_Wait_Suc_Rec17,
   csm_to_RESPMSGWAIT94,
   csm_to_ST_Done_Wait19,
   csm_to_ST_Wait_Suc_Tra18,
   csm_to_READ72,
   csm_to_ACK147,
   csm_to_ACK148,
   csm_to_REQMSGWAIT74,
...
begin : csm_wait_block_proc
   ...
   else if (csm_to_ST_Wait_Suc_Rec17 == 1'b1) begin
      csm_next_timer = 15'd1499;  //no cycles(1500)-1=1499
   end
   else if (csm_to_RESPMSGWAIT94 == 1'b1) begin
      csm_next_timer = 15'd1499;  //no cycles(1500)-1=1499
   end
   else if (csm_to_ST_Done_Wait19 == 1'b1) begin
      csm_next_timer = 15'd1499;  //no cycles(1500)-1=1499
   end
   else if (csm_to_ST_Wait_Suc_Tra18 == 1'b1) begin
      csm_next_timer = 15'd4999;  //no cycles(5000)-1=4999
   end
   else if (csm_to_READ72 == 1'b1) begin
      csm_next_timer = 15'd1499;  //no cycles(1500)-1=1499
   end
   else if (csm_to_ACK147 == 1'b1) begin
      csm_next_timer = 15'd1499;  //no cycles(1500)-1=1499
   end
   else if (csm_to_ACK148 == 1'b1) begin
      csm_next_timer = 15'd1499;  //no cycles(1500)-1=1499
   end
   else if (csm_to_REQMSGWAIT74 == 1'b1) begin
      csm_next_timer = 15'd1499;  //no cycles(1500)-1=1499
   end
