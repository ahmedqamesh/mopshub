...
parameter 
          ...
          ST_Rst_Cnt1       = 8'd30,
          ST_Rst_Cnt2       = 8'd31,
          ST_counter_Wait1  = 8'd32,
          ST_Done1          = 8'd33,
          ST_Loop_cnt2      = 8'd34,
          ST_Rst_Cnt3       = 8'd35,
          ST_counter_Wait2  = 8'd36,
          ST_test_tx_end    = 8'd37,
          ST_En_Buffer1     = 8'd38,
          ST_End_Read1      = 8'd39,
          REQMSG5           = 8'd40,
          RESPMSGWAIT85     = 8'd41,
          ST_Wait_Suc_Rec1  = 8'd42,
          RESPMSG5          = 8'd43,
          ST_Bus_cnt2       = 8'd44,
          ST_start_test     = 8'd45,
          ST_Enable_Data9   = 8'd46,
          ST_Wait_Suc_Tra10 = 8'd47,
          REQMSG15          = 8'd48,
          ST_Wait_Suc_Rec10 = 8'd49,
          RESPMSG15         = 8'd50,
          RESPMSGWAIT87     = 8'd51,
          ST_Done_Wait11    = 8'd52,
          ST_Enable_Data10  = 8'd53,
          ST_Wait_Suc_Tra11 = 8'd54,
          REQMSG16          = 8'd55,
          ST_Wait_Suc_Rec11 = 8'd56,
          RESPMSG16         = 8'd57,
          RESPMSGWAIT88     = 8'd58,
          ST_Done_Wait12    = 8'd59,
          ST_Enable_Data11  = 8'd60,
          ST_Wait_Suc_Tra12 = 8'd61,
          REQMSG17          = 8'd62,
          ST_Wait_Suc_Rec12 = 8'd63,
          RESPMSG17         = 8'd64,
          RESPMSGWAIT89     = 8'd65,
          ST_Done_Wait13    = 8'd66,
          ST_Wait_Suc_Tra14 = 8'd67,
          ST_Done_Wait15    = 8'd68,
          ST_En_Buffer2     = 8'd69,
          ST_End_Read2      = 8'd70,
          REQMSG19          = 8'd71,
          RESPMSGWAIT91     = 8'd72,
          ST_Wait_Suc_Rec14 = 8'd73,
          RESPMSG19         = 8'd74,
          ST_Bus_cnt3       = 8'd75,
          ST_start_test1    = 8'd76,
          ST_Wait_Suc_Tra15 = 8'd77,
          ST_Done_Wait16    = 8'd78,
          ST_En_Buffer3     = 8'd79,
          ST_End_Read3      = 8'd80,
          REQMSG20          = 8'd81,
          RESPMSGWAIT92     = 8'd82,
          ST_Wait_Suc_Rec15 = 8'd83,
          RESPMSG20         = 8'd84,
          ST_Bus_cnt4       = 8'd85,
          ST_start_test2    = 8'd86,
          ST_Wait_Suc_Tra16 = 8'd87,
          ST_Done_Wait17    = 8'd88,
          ST_En_Buffer4     = 8'd89,
          ST_End_Read4      = 8'd90,
          REQMSG21          = 8'd91,
          RESPMSGWAIT93     = 8'd92,
          ST_Wait_Suc_Rec16 = 8'd93,
          RESPMSG21         = 8'd94,
          ST_Bus_cnt5       = 8'd95,
          ST_start_test3    = 8'd96,
          ST_Wait_Suc_Tra17 = 8'd97,
          ST_Done_Wait18    = 8'd98,
          READ72            = 8'd99,
          ACK147            = 8'd100,
          ACK148            = 8'd101,
          RESPMSGWAIT78     = 8'd102,
          REQMSG74          = 8'd103,
          RESPMSG73         = 8'd104,
          Start1            = 8'd105,
          end_rand1         = 8'd106,
          _Wait3            = 8'd107,
          _Wait4            = 8'd108,
          ST_Enable_Data14  = 8'd109,
          ST_Wait_Suc_Tra19 = 8'd110,
          REQMSG23          = 8'd111,
          ST_Wait_Suc_Rec18 = 8'd112,
          RESPMSG23         = 8'd113,
          RESPMSGWAIT95     = 8'd114,
          ST_Done_Wait20    = 8'd115,
          _Wait7            = 8'd116,
          READ68            = 8'd117,
          READ69            = 8'd118,
          READ70            = 8'd119,
          ...
          ACK151            = 8'd121,
          ACK152            = 8'd122,
          RESPMSGWAIT80     = 8'd123,
          REQMSG76          = 8'd124,
          RESPMSG75         = 8'd125,
          _Wait5            = 8'd126,
          ST_Enable_Data15  = 8'd127,
          ST_Wait_Suc_Tra20 = 8'd128,
          REQMSG24          = 8'd129,
          ST_Wait_Suc_Rec19 = 8'd130,
          RESPMSG24         = 8'd131,
          RESPMSGWAIT96     = 8'd132,
          ST_Done_Wait21    = 8'd133,
          _Wait9            = 8'd134,
          _Wait8            = 8'd135,
          Wait              = 8'd136,
          rst_Cnt           = 8'd137,
          ST_Set_DATA11     = 8'd138,
          ST_Set_DATA12     = 8'd139,
          ST_Set_DATA13     = 8'd140,
          ST_Set_DATA14     = 8'd141,
          ST_Enable_Data16  = 8'd142,
          ST_Wait_Suc_Tra21 = 8'd143,
          REQMSG25          = 8'd144,
          ST_Wait_Suc_Rec20 = 8'd145,
          RESPMSG25         = 8'd146,
          RESPMSGWAIT97     = 8'd147,
          ST_Done_Wait22    = 8'd148,
          _Wait10           = 8'd149;
...
begin : next_state_block_proc
   ...
   case (current_state) 
      ...
      ST_Set_DATA11: begin
         if (tx_uart_done ==1)
            next_state = ST_Set_DATA12;
         else
            next_state = ST_Set_DATA11;
      end
      ST_Set_DATA12: begin
         if (tx_uart_done ==0)
            next_state = ST_Set_DATA13;
         else
            next_state = ST_Set_DATA12;
      end
      ST_Set_DATA13: begin
         if (tx_uart_done ==1)
            next_state = ST_Set_DATA14;
         else
            next_state = ST_Set_DATA13;
      end
      ST_Set_DATA14: begin
...
begin : output_block_proc
   ...
   case (current_state) 
      ...
      ST_Enable_Data14: begin
         rand_rec_in = {4'h4,7'h0,64'h180DBEEFDEADBEAF};
      ...
      ST_Enable_Data16: begin
         rand_rec_in = {4'h9,8'h0,64'hDEADBEEFDEADBEAF};
         start_write_emulator_spi = 1;
      end
      REQMSG25: begin
         reqmsg = 1 ;
...
begin : csm_wait_block_proc
   ...
   if (csm_to_READ65 == 1'b1) begin
      ...
      csm_next_timer = 16'd9999;  //no cycles(10000)-1=9999
   end
