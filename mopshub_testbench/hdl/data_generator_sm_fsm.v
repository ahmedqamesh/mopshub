...
begin : output_block_proc
   ...
   case (current_state) 
      ...
      ST_Enable_Data14: begin
         rand_rec_in = {4'h4,7'h0,64'hDEADBEEFDEADBEAF};
...
begin : csm_wait_block_proc
   ...
   if (csm_to_READ65 == 1'b1) begin
      ...
      csm_next_timer = 16'd39999;  //no cycles(40000)-1=39999
   end
      ...
      csm_next_timer = 16'd49999;  //no cycles(50000)-1=49999
   end
   else begin
