...
module mopshub_tb_elink_generator( 
   ...
   input   wire    [75:0]  data_rec_driver, 
   input   wire    [75:0]  data_rec_driver_spi, 
   input   wire            rst, 
   input   wire    [1:0]   rx_elink2bit, 
   input   wire            start_read_elink, 
   input   wire            start_write_elink, 
   input   wire            start_write_elink_spi, 
   output  wire    [75:0]  data_tra_driver, 
   output  wire    [75:0]  data_tra_mon_driver_spi, 
   output  wire    [75:0]  data_tra_power_driver_spi, 
...
elink_core elink_core_decoder( 
   ...
   .data_rec_uplink       (data_rec_driver), 
   ...
   .data_tra_out          (data_tra_driver), 
   .buffer_tra_en         (buffer_tra_en), 
   .data_tra_mon_spi      (data_tra_mon_driver_spi), 
   .data_rec_spi_in       (data_rec_driver_spi), 
   ...
   .end_write_elink_dbg   (), 
   .irq_elink_eth         (), 
   .data_tra_power_spi    (data_tra_power_driver_spi), 
   .irq_spi_power_on      (), 
   .buffer_eth_en         (), 
   .irq_spi_mon_tra       (), 
