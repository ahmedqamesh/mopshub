...
add wave -noupdate -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:response_cld
...
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:elink_proc_in_dec8b10b0:ISK_char
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:elink_proc_in_dec8b10b0:word10b
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:elink_proc_in_dec8b10b0:decoder_out
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:dec10b_out_rdy
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:elink_proc_in_dec8b10b0:bitstream_in
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:elink_proc_in_dec8b10b0:sync_detector0:align_select
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:elink_proc_in_dec8b10b0:sync_detector0:alignment_reg
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:elink_proc_in_dec8b10b0:sync_detector0:bitstream_align0
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:elink_proc_in_dec8b10b0:sync_detector0:bitstream_align1
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:elink_proc_in_dec8b10b0:sync_detector0:comma_valid_bits
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:elink_proc_in_dec8b10b0:sync_detector0:comma_valid_bits_or
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:disp_err
add wave -noupdate -group elink_to_fifo -radix hexadecimal :tb_mopshub_top_32bus:data_generator0:mopshub_decoder_emulator:elink_core_decoder:elink_to_fifo0:code_err
...
add wave -noupdate -group fifo_to_elink -radix hexadecimal :tb_mopshub_top_32bus:mopshub0:elink_core0:fifo_to_elink0:elink_proc_out_enc8b10b0:enc_8b10b_mopshub0:dataout
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {44411640 ns} 1} {{Cursor 2} {57013468 ns} 0}
...
update
WaveRestoreZoom {52202527 ns} {61379775 ns}
