...
add wave -noupdate -expand -group {SPI Monitoring} /tb_mopshub_top_16bus/mopshub0/spi_core0/bus_mon_select
...
add wave -noupdate -group {SPI Control} /tb_mopshub_top_16bus/mopshub0/set_power_init
add wave -noupdate -group {SPI Control} /tb_mopshub_top_16bus/mopshub0/start_power_init
add wave -noupdate -group {SPI Control} /tb_mopshub_top_16bus/mopshub0/end_power_init
add wave -noupdate -group {SPI Control} /tb_mopshub_top_16bus/mopshub0/spi_core0/sck_control
add wave -noupdate -group {SPI Control} /tb_mopshub_top_16bus/mopshub0/spi_core0/bus_control_select
add wave -noupdate -group {SPI Control} /tb_mopshub_top_16bus/mopshub0/spi_core0/cs_control
add wave -noupdate -group {SPI Control} /tb_mopshub_top_16bus/mopshub0/spi_core0/mosi_control
add wave -noupdate -group {SPI Control} /tb_mopshub_top_16bus/mopshub0/spi_core0/miso_control
add wave -noupdate -group {SPI Control} /tb_mopshub_top_16bus/mopshub0/spi_core0/ack_spi_control_receive
add wave -noupdate -group {SPI Control} /tb_mopshub_top_16bus/mopshub0/spi_core0/ack_spi_control_transmit
