...
if (!rst) dataout_valid_r <= 1'b0;
  ...
  begin 
    if (datain_valid) dataout_valid_r <= 1'b1;//edges of the data frame
...
initial 
  ...
  ISK_r             = 0;
  ISKcode_r         = 2'b0;
  EOBn              = 10'b1100001100;   //+K.28.3 
  EOBp              = 10'b0011110011;   //-K.28.3 
  EOCn              = 10'b1100001001;   //+K.28.6
  EOCp              = 10'b0011110110;   //-K.28.6 end-of-chunk characters
  SOBn              = 10'b1100001010;   //+K.28.2
  SOBp              = 10'b0011110101;   //-K.28.2 //start-of-busy and end-of-busy characters
  SOCn              = 10'b1100000110;   //+K.28.1 Ø¹Ø¨Ø¯Ø§ÙÙÙ �sØ§ÙÙØ¯ÙÙ
  SOCp              = 10'b0011111001;   //-K.28.1
  end
