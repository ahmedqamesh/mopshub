//
// Module mopshub_triplicated.macfsm2TMR.struct
//
// Created:
...
// Instances 
majorityVoter #(8) current_stateVoterA( 
   .inA    (current_stateA), 
   .inB    (current_stateB), 
   .inC    (current_stateC), 
...
majorityVoter #(8) current_stateVoterB( 
   .inA    (current_stateA), 
   .inB    (current_stateB), 
   .inC    (current_stateC), 
...
majorityVoter #(8) current_stateVoterC( 
   .inA    (current_stateA), 
   .inB    (current_stateB), 
   .inC    (current_stateC), 
