 ...
 *                                                                                                  *
 * file    : ./output/mopshub_top_board_16bus_structTMR.v                                           *
 *                                                                                                  *
 * user    : lucas                                                                                  *
 ...
 *                                                                                                  *
 * src file: mopshub_top_board_16bus_struct.v                                                       *
 *           Git SHA           : b25f042058e4e97751df2a0933c24aeadd5a78a5 (?? mopshub_top_board_16bus_struct.v) *
 *           Modification time : 2022-12-04 15:41:31.664210                                         *
 *           File Size         : 10760                                                              *
 *           MD5 hash          : 42f3bf57f0b6112e5a39182ee9d1abdf                                   *
 *                                                                                                  *
 ****************************************************************************************************/

`resetall 
`timescale  1ns/10ps
module mopshub_top_board_16busTMR(
  input wire  clk_40 ,
  input wire  clk_m ,
  input wire  locked ,
  input wire  miso_c ,
...
demux1_16_1bitTMR cs_active_c_mux (
...
demux1_16_1bitTMR cs_active_c_mux1 (
    .def_value(def_value_1),
    .sel(mon_bus_cnt),
...
mopshub_top_16busTMR mopshub_top_16bus0 (
    .clk(clk_40),
    .data_10bit_in_dbg(data_10bit_in_dbg),
