//
// Module mopshub_triplicated.CLK_CounterTMR.struct
//
// Created:
...
majorityVoter #(4) Counter_C_iVoterA( 
   .inA    (Counter_C_iA), 
   .inB    (Counter_C_iB), 
   .inC    (Counter_C_iC), 
...
majorityVoter #(4) Counter_C_iVoterB( 
   .inA    (Counter_C_iA), 
   .inB    (Counter_C_iB), 
   .inC    (Counter_C_iC), 
...
majorityVoter #(4) Counter_C_iVoterC( 
   .inA    (Counter_C_iA), 
   .inB    (Counter_C_iB), 
   .inC    (Counter_C_iC), 
