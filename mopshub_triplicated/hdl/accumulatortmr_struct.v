//
// Module mopshub_triplicated.AccumulatorTMR.struct
//
// Created:
...
// Instances 
majorityVoter #(((WidthAcc-1)>(0)) ? ((WidthAcc-1)-(0)+1) : ((0)-(WidthAcc-1)+1)) accVoterA( 
   .inA    (accA), 
   .inB    (accB), 
   .inC    (accC), 
   .out    (accVotedA), 
...
majorityVoter #(((WidthAcc-1)>(0)) ? ((WidthAcc-1)-(0)+1) : ((0)-(WidthAcc-1)+1)) accVoterB( 
   .inA    (accA), 
   .inB    (accB), 
   .inC    (accC), 
   .out    (accVotedB), 
...
majorityVoter #(((WidthAcc-1)>(0)) ? ((WidthAcc-1)-(0)+1) : ((0)-(WidthAcc-1)+1)) accVoterC( 
   .inA    (accA), 
   .inB    (accB), 
   .inC    (accC), 
   .out    (accVotedC), 
