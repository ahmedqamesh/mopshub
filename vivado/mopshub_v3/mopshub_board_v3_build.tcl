...
proc checkRequiredFiles { origin_dir} {
  ...
  set files [list \
   ...
   #"/run/media/dcs/data2/workspaces/mopshub_board/mopshub_board.srcs/sources_1/bd/mopshub_board_v3/mopshub_board_v3.bd" \
...
set _xil_proj_name_ "mopshub_board_v3"
...
set script_file "mopshub_board_v3_build.tcl"
...
# Create block design
 source $origin_dir/src/bd/mopshub_v3_bd.tcl
 after 2000
...
#set file "mopshub_board_v3/mopshub_board_v3.bd"
#set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
#set_property -name "registered_with_manager" -value "1" -objects $file_obj

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse ${_xil_proj_name_}.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/${_xil_proj_name_}/${_xil_proj_name_}.gen/sources_1/bd/${_xil_proj_name_}/hdl/mopshub_board_v3_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse ${_xil_proj_name_}.bd] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}

#add_files -norecurse  "${origin_dir}/${_xil_proj_name_}/${_xil_proj_name_}.gen/sources_1/bd/${_xil_proj_name_}/hdl/mopshub_board_v3_wrapper.v" 
after 2000
...
set obj [get_filesets sources_1]
set_property -name "top" -value "mopshub_board_v3_wrapper" -objects $obj
...
set_property top mopshub_board_v3_wrapper [current_fileset]
update_compile_order -fileset sources_1
