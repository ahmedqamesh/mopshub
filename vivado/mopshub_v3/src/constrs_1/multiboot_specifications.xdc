...
add_cells_to_pblock [get_pblocks SEM_CONTROLLER] [get_cells -quiet [list mopshub_board_v3_i/sem_controller_wrapp_0/inst/sem_0_sem_controller0]]
add_cells_to_pblock [get_pblocks SEM_CONTROLLER] [get_cells -quiet mopshub_board_v3_i/sem_controller_wrapp_0/inst/sem_0_sem_controller0/*]
##add_cells_to_pblock [get_pblocks SEM_CONTROLLER] [get_cells mopshub_board_v3_i/sem_controller_wrapp_0/sem_0_sem_controller0]
## Force ICAP to the required (top) site in the device.
## Force FRAME_ECC to the required (only) site in the device.
set_property LOC FRAME_ECC_X0Y0 [get_cells mopshub_board_v3_i/sem_controller_wrapp_0/inst/sem_0_sem_cfg0/frame_ecc_init0]
set_property LOC ICAP_X0Y1 [get_cells mopshub_board_v3_i/sem_controller_wrapp_0/inst/sem_0_sem_cfg0/icap_init0]
####################################################################################################################################
