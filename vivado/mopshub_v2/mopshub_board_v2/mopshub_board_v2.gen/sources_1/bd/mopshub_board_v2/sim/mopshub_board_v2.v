...
//Date        : Thu Jun 13 00:58:54 2024
//Host        : chipdev2.physik.uni-wuppertal.de running 64-bit unknown
//Command     : generate_target mopshub_board_v2.bd
//Design      : mopshub_board_v2
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "mopshub_board_v2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mopshub_board_v2,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=14,numReposBlks=14,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "mopshub_board_v2.hwdef" *) 
module mopshub_board_v2
   (WDI_0,
    clk_ext_clk_n,
    clk_ext_clk_p,
    clk_out_n_0,
  ...
  wire clk_elink_m_1_CLK_N;
  wire clk_elink_m_1_CLK_P;
  wire clk_sys_1;
  wire clk_wiz_0_clk_100;
  wire clk_wiz_s1_clk_elink;
  wire clk_wiz_s1_clk_rx_m;
  wire clk_wiz_s1_clk_tx_m;
  ...
  assign clk_elink_m_1_CLK_N = clk_ext_clk_n;
  assign clk_elink_m_1_CLK_P = clk_ext_clk_p;
  assign clk_out_n_0 = mopshub_top_board_16_0_clk_out_n;
  assign clk_out_p_0 = mopshub_top_board_16_0_clk_out_p;
  assign clk_sys_1 = clk_sys;
  ...
  assign disable_sw_0_1 = disable_sw_0;
  ...
  mopshub_board_v2_clk_wiz_0_0 clk_wiz_0
       (.clk_100(clk_wiz_0_clk_100),
        .clk_in1(clk_wiz_s_clk_40));
  mopshub_board_v2_clk_wiz_s_0 clk_wiz_s
       (.clk_40(clk_wiz_s_clk_40),
        .clk_in1(clk_sys_1),
        .clk_m(clk_wiz_s_clk_m),
        .clk_uart(clk_wiz_s_clk_uart),
        .locked(clk_wiz_s_locked));
  mopshub_board_v2_clk_wiz_s1_0 clk_wiz_s1
       (.clk_elink(clk_wiz_s1_clk_elink),
        .clk_in1_n(clk_elink_m_1_CLK_N),
        .clk_in1_p(clk_elink_m_1_CLK_P),
        .clk_rx_m(clk_wiz_s1_clk_rx_m),
        .clk_tx_m(clk_wiz_s1_clk_tx_m));
  mopshub_board_v2_ila_0_0 ila_0
  ...
  mopshub_board_v2_ila_1_0 ila_1
       (.clk(clk_wiz_s_clk_40),
        .probe0(mopshub_top_board_16_0_simple_out),
        .probe1(mopshub_top_board_16_0_tmr_out));
  mopshub_board_v2_ip_buf_0_0 ip_buf_0
       (.input_wire(clk_wiz_s_clk_40),
        .output_wire(ip_buf_0_output_wire));
  mopshub_board_v2_mopshub_top_board_16_0_0 mopshub_top_board_16_0
       (.clk_40(clk_wiz_s_clk_40),
        .clk_elink(clk_wiz_s1_clk_elink),
        .clk_m(clk_wiz_s_clk_m),
  ...
  mopshub_board_v2_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
  ...
  mopshub_board_v2_selectio_wiz_0_0 selectio_wiz_0
       (.bitslip(xlconstant_0_dout),
        .clk_div_in(clk_wiz_s1_clk_elink),
        .clk_in(clk_wiz_s1_clk_rx_m),
  ...
  mopshub_board_v2_selectio_wiz_2_0 selectio_wiz_2
       (.clk_div_in(clk_wiz_s1_clk_elink),
        .clk_in(clk_wiz_s1_clk_tx_m),
        ...
        .io_reset(xlconstant_1_dout));
  mopshub_board_v2_sem_controller_wrapp_0_0 sem_controller_wrapp_0
  ...
  mopshub_board_v2_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout1));
  mopshub_board_v2_xlconstant_1_0 xlconstant_1
       (.dout(xlconstant_1_dout1));
  mopshub_board_v2_xlconstant_bit_0 xlconstant_bit
