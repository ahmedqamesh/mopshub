//
// Module mopshub_32bus.node_tra_demux_32.struct
//
// Created:
//          by - dcs.dcs (chipdev2.physik.uni-wuppertal.de)
//          at - 12:39:54 03/15/24
//
...
module node_tra_demux_32( 
   ...
   output  wire    [15:0]  writedata16, 
   output  wire    [15:0]  writedata17, 
   output  wire    [15:0]  writedata18, 
   output  wire    [15:0]  writedata19, 
   output  wire    [15:0]  writedata2, 
   output  wire    [15:0]  writedata20, 
   output  wire    [15:0]  writedata21, 
   output  wire    [15:0]  writedata22, 
   output  wire    [15:0]  writedata23, 
   output  wire    [15:0]  writedata24, 
   output  wire    [15:0]  writedata25, 
   output  wire    [15:0]  writedata26, 
   output  wire    [15:0]  writedata27, 
   output  wire    [15:0]  writedata28, 
   output  wire    [15:0]  writedata29, 
   output  wire    [15:0]  writedata3, 
   output  wire    [15:0]  writedata30, 
   output  wire    [15:0]  writedata31, 
...
// Instances 
mux32_1_1bit mux32_1_1bit_irqtra( 
   .clk         (clk), 
   .rst         (rst), 
   .sel         (bus_tra_select), 
...
demux1_32_16bit demux1_16_16bit_writedata( 
   .sel       (bus_tra_select), 
   .input_bus (writedata), 
   .output0   (writedata0), 
   .output1   (writedata1), 
...
demux1_32_1bit demux1_32_1bit_cs( 
   .def_value  (def_value_0), 
   .sel        (bus_tra_select), 
...
demux1_32_1bit demux1_32_1bit_write( 
...
// HDL Embedded Text Block 5 assign_wire2
// eb1 1  
initial                                      
begin
  def_value_1 = 1'b1;
